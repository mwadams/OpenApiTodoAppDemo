...
public readonly partial struct LoginRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(LoginRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="LoginRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LoginRequest(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.LoginRequest.TheUserSPassword.Mutable Password
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out TodoApp.Identity.Server.Models.LoginRequest.TheUserSPassword.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new LoginRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPassword(in TodoApp.Identity.Server.Models.LoginRequest.TheUserSPassword.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LoginRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LoginRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LoginRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly LoginRequest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<LoginRequest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LoginRequest"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly LoginRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<LoginRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Identity.Server.Models.LoginRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(LoginRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Identity.Server.Models.LoginRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="LoginRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Identity.Server.Models.JsonEmail.Source email,
            in TodoApp.Identity.Server.Models.LoginRequest.TheUserSPassword.Source password)
        {
        ...
        /// Creates an instance of a <see cref="LoginRequest"/>.
        /// </summary>
        public void Create(in TodoApp.Identity.Server.Models.JsonEmail.Source email, in TodoApp.Identity.Server.Models.LoginRequest.TheUserSPassword.Source password)
        {
            Create(ref _builder, email, password);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Identity.Server.Models.JsonEmail.Source email, in TodoApp.Identity.Server.Models.LoginRequest.TheUserSPassword.Source password, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(email, password);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<LoginRequest, Mutable>(this);
    }
}
