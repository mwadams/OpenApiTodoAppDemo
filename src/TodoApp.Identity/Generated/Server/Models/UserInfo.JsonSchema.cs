    ...
    : IJsonElement<UserInfo>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("sub"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertySubNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("sub"u8, buffer, out written);

        private const int RequiredOffsetForSub = 0;
        private const uint RequiredBitForSub = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForEmail | RequiredBitForName | RequiredBitForSub;
        ...
        private static readonly JsonSchemaPathProvider SubSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/sub"u8, buffer, out written);
        ...
        private static void MatchEmail(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                TodoApp.Identity.Server.Models.JsonEmail.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Identity.Server.Models.JsonEmail.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchSub(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                TodoApp.Identity.Server.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.SubUtf8,
                    evaluationPath: SubSchemaEvaluationPath);

            TodoApp.Identity.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            requiredBitBuffer[RequiredOffsetForSub] |= RequiredBitForSub;
        }

        private static PropertySchemaMatchers<TodoApp.Identity.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<TodoApp.Identity.Server.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.EmailUtf8, MatchEmail),
                (static () => JsonPropertyNames.NameUtf8, MatchName),
                (static () => JsonPropertyNames.SubUtf8, MatchSub),
            ]);
        }

        private static PropertySchemaMatchers<TodoApp.Identity.Server.Models.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out TodoApp.Identity.Server.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/UserInfo"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/UserInfo";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/UserInfo"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out TodoApp.Identity.Server.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySubPresent, "sub"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSub] & RequiredBitForSub) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertySubNotPresent, "sub"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertySubPresent, "sub"u8, "required"u8);
