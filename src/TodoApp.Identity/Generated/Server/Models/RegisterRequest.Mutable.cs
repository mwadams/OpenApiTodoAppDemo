...
public readonly partial struct RegisterRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(RegisterRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="RegisterRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RegisterRequest(Mutable instance)
        {
        ...
        /// <remarks>
        /// <para>
        /// Optional display name (defaults to email if omitted)
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.JsonString.Mutable DisplayName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Identity.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.RegisterRequest.TheUserSPassword.Mutable Password
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out TodoApp.Identity.Server.Models.RegisterRequest.TheUserSPassword.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RegisterRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDisplayName(in TodoApp.Identity.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPassword(in TodoApp.Identity.Server.Models.RegisterRequest.TheUserSPassword.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RegisterRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RegisterRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RegisterRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly RegisterRequest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RegisterRequest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RegisterRequest"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly RegisterRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<RegisterRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Identity.Server.Models.RegisterRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(RegisterRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Identity.Server.Models.RegisterRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="RegisterRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Identity.Server.Models.JsonEmail.Source email,
            in TodoApp.Identity.Server.Models.RegisterRequest.TheUserSPassword.Source password,
            in TodoApp.Identity.Server.Models.JsonString.Source displayName = default)
        {
        ...
        public void Create(
            ...
            in TodoApp.Identity.Server.Models.JsonString.Source displayName = default)
        {
            Create(ref _builder, email, password, displayName);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Identity.Server.Models.JsonEmail.Source email, in TodoApp.Identity.Server.Models.RegisterRequest.TheUserSPassword.Source password, in TodoApp.Identity.Server.Models.JsonString.Source displayName = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(email, password, displayName);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<RegisterRequest, Mutable>(this);
    }
}
