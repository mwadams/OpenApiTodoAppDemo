...
namespace TodoApp.Identity.Server.Models;
/// <summary>
/// Generated from JSON Schema.
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct UserInfo
{
...
#endif
    {
        ...
        public static explicit operator Mutable(UserInfo instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="UserInfo"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UserInfo(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.JsonEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Identity.Server.Models.JsonEmail.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.JsonString.Mutable Sub
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubUtf8, out TodoApp.Identity.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UserInfo(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetEmail(in TodoApp.Identity.Server.Models.JsonEmail.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(in TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSub(in TodoApp.Identity.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("sub");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UserInfo.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="UserInfo"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="UserInfo"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly UserInfo Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<UserInfo>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="UserInfo"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly UserInfo Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<UserInfo>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Identity.Server.Models.UserInfo.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(UserInfo instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Identity.Server.Models.UserInfo.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="UserInfo"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Identity.Server.Models.JsonEmail.Source email,
            in TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.Source name,
            in TodoApp.Identity.Server.Models.JsonString.Source sub)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Identity.Server.Models.JsonEmail.Source email, in TodoApp.Identity.Server.Models.UserInfo.TheUserSDisplayName.Source name, in TodoApp.Identity.Server.Models.JsonString.Source sub, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<UserInfo, Mutable>(this);
    }
}
