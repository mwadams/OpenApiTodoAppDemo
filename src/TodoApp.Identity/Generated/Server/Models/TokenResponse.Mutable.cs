...
public readonly partial struct TokenResponse
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TokenResponse instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TokenResponse"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TokenResponse(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.JsonString.Mutable Token
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUtf8, out TodoApp.Identity.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetToken(in TodoApp.Identity.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TokenResponse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TokenResponse Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TokenResponse Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TokenResponse>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Identity.Server.Models.TokenResponse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TokenResponse instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Identity.Server.Models.TokenResponse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="TokenResponse"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in TodoApp.Identity.Server.Models.JsonString.Source token)
        {
        ...
        /// Creates an instance of a <see cref="TokenResponse"/>.
        /// </summary>
        public void Create(in TodoApp.Identity.Server.Models.JsonString.Source token)
        {
            Create(ref _builder, token);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Identity.Server.Models.JsonString.Source token, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<TokenResponse, Mutable>(this);
    }
}
