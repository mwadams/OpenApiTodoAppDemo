...
public readonly partial struct UserInfo
{
    ...
    public readonly partial struct TheUserSDisplayName
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheUserSDisplayName instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheUserSDisplayName"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheUserSDisplayName(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheUserSDisplayName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheUserSDisplayName Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheUserSDisplayName Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheUserSDisplayName>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheUserSDisplayName instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheUserSDisplayName, Mutable>(this);
        }
    }
}
