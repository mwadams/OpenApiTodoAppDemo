...
public readonly partial struct ErrorResponse
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ErrorResponse instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ErrorResponse"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ErrorResponse(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Identity.Server.Models.JsonString.Mutable Error
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out TodoApp.Identity.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetError(in TodoApp.Identity.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ErrorResponse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly ErrorResponse Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly ErrorResponse Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ErrorResponse>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Identity.Server.Models.ErrorResponse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ErrorResponse instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Identity.Server.Models.ErrorResponse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ErrorResponse"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in TodoApp.Identity.Server.Models.JsonString.Source error)
        {
        ...
        /// Creates an instance of a <see cref="ErrorResponse"/>.
        /// </summary>
        public void Create(in TodoApp.Identity.Server.Models.JsonString.Source error)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Identity.Server.Models.JsonString.Source error, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<ErrorResponse, Mutable>(this);
    }
}
