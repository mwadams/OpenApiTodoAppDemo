...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Runtime.Models.JsonUriReference CallbackUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CallbackUrlUtf8, out TodoApp.Broker.Runtime.Models.JsonUriReference value))
            {
                return value;
            }
