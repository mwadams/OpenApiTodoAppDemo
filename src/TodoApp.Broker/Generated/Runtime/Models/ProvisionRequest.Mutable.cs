...
public readonly partial struct ProvisionRequest
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Runtime.Models.JsonUriReference.Mutable CallbackUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CallbackUrlUtf8, out TodoApp.Broker.Runtime.Models.JsonUriReference.Mutable value))
                {
                    return value;
                }
        ...
        public void SetCallbackUrl(in TodoApp.Broker.Runtime.Models.JsonUriReference.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Runtime.Models.ProvisionRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Runtime.Models.ProvisionRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Broker.Runtime.Models.JsonUriReference.Source callbackUrl,
        ...
        /// Creates an instance of a <see cref="ProvisionRequest"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.Runtime.Models.JsonUriReference.Source callbackUrl, in Corvus.Text.Json.JsonElement.Source payload)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Runtime.Models.JsonUriReference.Source callbackUrl, in Corvus.Text.Json.JsonElement.Source payload, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.Runtime.Models.JsonUriReference.Source callbackUrl, in Corvus.Text.Json.JsonElement.Source<TContext> payload, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
