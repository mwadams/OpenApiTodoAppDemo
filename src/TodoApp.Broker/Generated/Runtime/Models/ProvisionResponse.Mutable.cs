...
public readonly partial struct ProvisionResponse
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Runtime.Models.ProvisionResponse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Runtime.Models.ProvisionResponse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity.Source status,
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity.Source status, in TodoApp.Broker.Runtime.Models.JsonUuid.Source ticket, in TodoApp.Broker.Runtime.Models.JsonString.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
