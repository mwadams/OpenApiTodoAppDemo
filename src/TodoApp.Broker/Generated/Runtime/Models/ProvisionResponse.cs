...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Runtime.Models.ProvisionResponse.StatusEntity value))
            {
                return value;
            }
