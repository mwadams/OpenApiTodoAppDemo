...
#endif
{
    ...
    /// </summary>
    public TodoApp.Broker.Runtime.Models.JsonDateTime CreatedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CreatedAtUtf8, out TodoApp.Broker.Runtime.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Runtime.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Broker.Runtime.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Runtime.Models.JsonInt32 RetryAfterSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetryAfterSecondsUtf8, out TodoApp.Broker.Runtime.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Runtime.Models.ProvisioningStatus.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Runtime.Models.ProvisioningStatus.StatusEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Runtime.Models.JsonUuid Ticket
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TicketUtf8, out TodoApp.Broker.Runtime.Models.JsonUuid value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Broker.Runtime.Models.JsonDateTime UpdatedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdatedAtUtf8, out TodoApp.Broker.Runtime.Models.JsonDateTime value))
            {
                return value;
            }
