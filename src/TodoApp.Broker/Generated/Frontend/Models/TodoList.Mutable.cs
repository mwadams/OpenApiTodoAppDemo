...
public readonly partial struct TodoList
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoList instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoList"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoList(Mutable instance)
        {
        ...
        public TodoApp.Broker.Frontend.Models.TodoItem.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Broker.Frontend.Models.TodoItem.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Broker.Frontend.Models.TodoItem.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.TodoItem.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TodoList(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in TodoApp.Broker.Frontend.Models.TodoItem.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in TodoApp.Broker.Frontend.Models.TodoItem.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in TodoApp.Broker.Frontend.Models.TodoItem.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in TodoApp.Broker.Frontend.Models.TodoItem item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Broker.Frontend.Models.TodoItem>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<TodoApp.Broker.Frontend.Models.TodoItem> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Broker.Frontend.Models.TodoItem>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in TodoApp.Broker.Frontend.Models.TodoItem oldItem, in TodoApp.Broker.Frontend.Models.TodoItem.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.TodoItem>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                TodoApp.Broker.Frontend.Models.TodoItem current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="TodoList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TodoList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly TodoList Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TodoList>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TodoList"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly TodoList Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoList>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.TodoList.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TodoList instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.TodoList.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<TodoList, Mutable>(this);
    }
}
