...
#endif
{
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity Description
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity value))
            {
                return value;
            }
