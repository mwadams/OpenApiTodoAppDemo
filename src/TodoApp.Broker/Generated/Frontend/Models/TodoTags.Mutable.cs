...
public readonly partial struct TodoTags
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoTags instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoTags"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoTags(Mutable instance)
        {
        ...
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Broker.Frontend.Models.JsonString.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Broker.Frontend.Models.JsonString.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.JsonString.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TodoTags(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoTags.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in TodoApp.Broker.Frontend.Models.JsonString item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Broker.Frontend.Models.JsonString>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<TodoApp.Broker.Frontend.Models.JsonString> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Broker.Frontend.Models.JsonString>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in TodoApp.Broker.Frontend.Models.JsonString oldItem, in TodoApp.Broker.Frontend.Models.JsonString.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.JsonString>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                TodoApp.Broker.Frontend.Models.JsonString current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="TodoTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TodoTags"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly TodoTags Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TodoTags>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TodoTags"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly TodoTags Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoTags>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.TodoTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TodoTags instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.TodoTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<TodoTags, Mutable>(this);
    }
}
