...
#endif
{
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.AddMemberRequest.RoleEntity Role
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Broker.Frontend.Models.AddMemberRequest.RoleEntity value))
            {
                return value;
            }

            return TodoApp.Broker.Frontend.Models.AddMemberRequest.RoleEntity.DefaultInstance;
        }
    }
