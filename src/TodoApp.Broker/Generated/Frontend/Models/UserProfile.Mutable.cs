...
public readonly partial struct UserProfile
{
...
#endif
    {
        ...
        public static explicit operator Mutable(UserProfile instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="UserProfile"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UserProfile(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable DisplayName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Broker.Frontend.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public TodoApp.Broker.Frontend.Models.JsonEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Broker.Frontend.Models.JsonEmail.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// The identity subject (sub) for the user
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Broker.Frontend.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Mutable Organizations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrganizationsUtf8, out TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UserProfile(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDisplayName(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEmail(in TodoApp.Broker.Frontend.Models.JsonEmail.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrganizations(in TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrganizations<TContext>(in TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UserProfile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="UserProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="UserProfile"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly UserProfile Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<UserProfile>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="UserProfile"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly UserProfile Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<UserProfile>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.UserProfile.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(UserProfile instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.UserProfile.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="UserProfile"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonString.Source displayName,
            in TodoApp.Broker.Frontend.Models.JsonString.Source id,
            in TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Source organizations,
            in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default)
        {
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default)
        {
            Create(ref _builder, displayName, id, organizations, email);
        }
        ...
        internal static void Create<TContext>(
            ...
            in TodoApp.Broker.Frontend.Models.JsonString.Source displayName,
            in TodoApp.Broker.Frontend.Models.JsonString.Source id,
            in TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Source<TContext> organizations,
            in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, displayName, id, organizations, email);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonString.Source displayName, in TodoApp.Broker.Frontend.Models.JsonString.Source id, in TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Source organizations, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(displayName, id, organizations, email);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.Frontend.Models.JsonString.Source displayName, in TodoApp.Broker.Frontend.Models.JsonString.Source id, in TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Source<TContext> organizations, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, displayName, id, organizations, email);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<UserProfile, Mutable>(this);
    }
}
