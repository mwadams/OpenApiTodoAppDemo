...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity DisplayName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity value))
            {
                return value;
            }
