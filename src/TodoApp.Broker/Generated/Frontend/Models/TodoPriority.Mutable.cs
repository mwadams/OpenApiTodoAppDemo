...
public readonly partial struct TodoPriority
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoPriority instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoPriority"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoPriority(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoPriority.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TodoPriority Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TodoPriority Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoPriority>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TodoPriority instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<TodoPriority, Mutable>(this);
    }
}
