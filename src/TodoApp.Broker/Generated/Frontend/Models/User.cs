...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.JsonString DisplayName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Broker.Frontend.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.JsonEmail Email
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Broker.Frontend.Models.JsonEmail value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.User.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Frontend.Models.User.StatusEntity value))
            {
                return value;
            }
