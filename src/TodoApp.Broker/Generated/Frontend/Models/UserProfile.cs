...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.JsonString Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Broker.Frontend.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.OrganizationMembershipList Organizations
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrganizationsUtf8, out TodoApp.Broker.Frontend.Models.OrganizationMembershipList value))
            {
                return value;
            }
