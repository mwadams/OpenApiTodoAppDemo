...
public readonly partial struct TodoStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoStatus(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TodoStatus Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TodoStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoStatus>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TodoStatus instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<TodoStatus, Mutable>(this);
    }
}
