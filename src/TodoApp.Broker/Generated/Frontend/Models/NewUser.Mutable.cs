...
public readonly partial struct NewUser
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity.Mutable DisplayName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDisplayName(in TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.NewUser.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.NewUser.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity.Source displayName,
        ...
        /// Creates an instance of a <see cref="NewUser"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity.Source displayName, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.NewUser.DisplayNameEntity.Source displayName, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
