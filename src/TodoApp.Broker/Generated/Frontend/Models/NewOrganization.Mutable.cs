...
public readonly partial struct NewOrganization
{
...
#endif
    {
        ...
        /// </summary>
        public TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDescription(in TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(in TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.NewOrganization.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.NewOrganization.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity.Source name,
            in TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity.Source description = default)
        {
        ...
        /// Creates an instance of a <see cref="NewOrganization"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity.Source name, in TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity.Source description = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.NewOrganization.NameEntity.Source name, in TodoApp.Broker.Frontend.Models.NewOrganization.DescriptionEntity.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
