...
public readonly partial struct User
{
...
#endif
    {
        ...
        public static explicit operator Mutable(User instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="User"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator User(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.User.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Frontend.Models.User.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new User(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.Frontend.Models.User.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"User.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="User"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="User"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly User Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<User>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="User"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly User Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<User>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.User.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(User instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.User.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="User"/>.
        /// </summary>
        internal static void Create(
            ...
            in TodoApp.Broker.Frontend.Models.User.StatusEntity.Source status,
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source provisioningTicket = default)
        {
            Create(ref _builder, displayName, id, status, email, provisioningTicket);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonString.Source displayName, in TodoApp.Broker.Frontend.Models.JsonUuid.Source id, in TodoApp.Broker.Frontend.Models.User.StatusEntity.Source status, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default, in TodoApp.Broker.Frontend.Models.JsonUuid.Source provisioningTicket = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(displayName, id, status, email, provisioningTicket);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<User, Mutable>(this);
    }
}
