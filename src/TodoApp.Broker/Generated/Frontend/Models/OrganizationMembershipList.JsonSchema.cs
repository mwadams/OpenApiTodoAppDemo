    ...
    : IJsonElement<OrganizationMembershipList>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/OrganizationMembershipList"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/OrganizationMembershipList";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/OrganizationMembershipList"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = TodoApp.Broker.Frontend.Models.OrganizationMembership.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    TodoApp.Broker.Frontend.Models.OrganizationMembership.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
