...
public readonly partial struct TodoDescription
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoDescription instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoDescription"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoDescription(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoDescription.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TodoDescription Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TodoDescription Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoDescription>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TodoDescription instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<TodoDescription, Mutable>(this);
    }
}
