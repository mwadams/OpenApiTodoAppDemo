...
public readonly partial struct OrganizationMembership
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OrganizationMembership instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OrganizationMembership"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OrganizationMembership(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable OrgName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgNameUtf8, out TodoApp.Broker.Frontend.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.OrganizationMembership.RoleEntity.Mutable Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Broker.Frontend.Models.OrganizationMembership.RoleEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OrganizationMembership(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>orgName</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrgName(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("orgName");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrgName, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRole(in TodoApp.Broker.Frontend.Models.OrganizationMembership.RoleEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OrganizationMembership.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OrganizationMembership"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OrganizationMembership"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMembership Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OrganizationMembership>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OrganizationMembership"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMembership Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OrganizationMembership>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.OrganizationMembership.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(OrganizationMembership instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.OrganizationMembership.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="OrganizationMembership"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source orgId,
            in TodoApp.Broker.Frontend.Models.JsonString.Source orgName,
            in TodoApp.Broker.Frontend.Models.OrganizationMembership.RoleEntity.Source role,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source joinedAt = default)
        {
            ...
            orgName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrgName, ref builder);
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source joinedAt = default)
        {
            Create(ref _builder, orgId, orgName, role, joinedAt);
        }
    ...
    /// <param name="orgName">The value of the property.</param>
    /// <param name="role">The value of the property.</param>
    /// <param name="joinedAt">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonUuid.Source orgId, in TodoApp.Broker.Frontend.Models.JsonString.Source orgName, in TodoApp.Broker.Frontend.Models.OrganizationMembership.RoleEntity.Source role, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source joinedAt = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(orgId, orgName, role, joinedAt);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<OrganizationMembership, Mutable>(this);
    }
}
