    ...
    : IJsonElement<TodoItem>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForPriority = 0b00000000000000000000000000000100;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForCreatedAt | RequiredBitForId | RequiredBitForPriority | RequiredBitForStatus |
            RequiredBitForTitle;
        private static readonly JsonSchemaPathProvider AssigneeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/assignee"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider DueDateSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/dueDate"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider PrioritySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/priority/$ref"u8, buffer, out written);
        ...
        private static void MatchAssignee(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                TodoApp.Broker.Frontend.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AssigneeUtf8,
                    evaluationPath: AssigneeSchemaEvaluationPath);

            TodoApp.Broker.Frontend.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchCreatedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            TodoApp.Broker.Frontend.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchDescription(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                TodoApp.Broker.Frontend.Models.TodoDescription.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.Frontend.Models.TodoDescription.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            context.CommitChildContext(childContext2.IsMatch, ref childContext2);
        }

        private static void MatchDueDate(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext3 =
                TodoApp.Broker.Frontend.Models.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.DueDateUtf8,
                    evaluationPath: DueDateSchemaEvaluationPath);

            TodoApp.Broker.Frontend.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static void MatchPriority(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext5 =
                TodoApp.Broker.Frontend.Models.TodoPriority.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.Frontend.Models.TodoPriority.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext6 =
                TodoApp.Broker.Frontend.Models.TodoStatus.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.Frontend.Models.TodoStatus.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext6);
        ...
        private static void MatchTags(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext7 =
                TodoApp.Broker.Frontend.Models.TodoTags.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.Frontend.Models.TodoTags.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext7);
        ...
        private static void MatchTitle(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext8 =
                TodoApp.Broker.Frontend.Models.TodoTitle.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.Frontend.Models.TodoTitle.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext8);
        ...
        private static void MatchUpdatedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            TodoApp.Broker.Frontend.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext9);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/TodoItem"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/TodoItem";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/TodoItem"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyPriorityPresent, "priority"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyStatusPresent, "status"u8, "required"u8);
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyPriorityNotPresent, "priority"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyPriorityPresent, "priority"u8, "required"u8);
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 3, RequiredPropertyStatusNotPresent, "status"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 3, RequiredPropertyStatusPresent, "status"u8, "required"u8);
