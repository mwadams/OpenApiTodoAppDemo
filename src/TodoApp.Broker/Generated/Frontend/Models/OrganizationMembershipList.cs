...
public readonly partial struct OrganizationMembershipList
    ...
    : IJsonElement<OrganizationMembershipList>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OrganizationMembershipList"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal OrganizationMembershipList(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static OrganizationMembershipList DefaultInstance { get; }
    ...
    public TodoApp.Broker.Frontend.Models.OrganizationMembership this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<TodoApp.Broker.Frontend.Models.OrganizationMembership>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<TodoApp.Broker.Frontend.Models.OrganizationMembership> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.OrganizationMembership>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in OrganizationMembershipList left, in OrganizationMembershipList right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in OrganizationMembershipList left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(OrganizationMembershipList instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator OrganizationMembershipList(JsonElement instance)
    {
        return OrganizationMembershipList.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static OrganizationMembershipList From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static OrganizationMembershipList ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<OrganizationMembershipList>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static OrganizationMembershipList ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<OrganizationMembershipList>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static OrganizationMembershipList ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<OrganizationMembershipList>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static OrganizationMembershipList ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<OrganizationMembershipList>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out OrganizationMembershipList? result)
    {
        return JsonElementHelpers.TryParseValue<OrganizationMembershipList>(ref reader, out result);
    }
...
#if NET
    static OrganizationMembershipList IJsonElement<OrganizationMembershipList>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"OrganizationMembershipList: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public OrganizationMembershipList Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public OrganizationMembershipList Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<OrganizationMembershipList>(_idx);
        }
