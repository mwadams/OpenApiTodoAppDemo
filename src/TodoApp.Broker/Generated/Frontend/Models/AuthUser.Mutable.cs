...
public readonly partial struct AuthUser
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AuthUser instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AuthUser"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AuthUser(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>sub</c> property.
        /// </summary>
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable Sub
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubUtf8, out TodoApp.Broker.Frontend.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AuthUser(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>sub</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSub(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SubUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Sub, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>sub</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveSub()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SubUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AuthUser.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AuthUser"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AuthUser"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AuthUser Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AuthUser>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AuthUser"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AuthUser Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AuthUser>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.AuthUser.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(AuthUser instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.AuthUser.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AuthUser"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default,
            in TodoApp.Broker.Frontend.Models.JsonString.Source name = default,
            in TodoApp.Broker.Frontend.Models.JsonString.Source sub = default)
        {
            ...
            sub.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Sub, ref builder);
        }
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.JsonString.Source sub = default)
        {
            Create(ref _builder, email, name, sub);
        }
    ...
    /// <param name="sub">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email = default, in TodoApp.Broker.Frontend.Models.JsonString.Source name = default, in TodoApp.Broker.Frontend.Models.JsonString.Source sub = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(email, name, sub);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AuthUser, Mutable>(this);
    }
}
