...
public readonly partial struct TodoItem
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoItem instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoItem(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>assignee</c> property.
        /// </summary>
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable Assignee
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AssigneeUtf8, out TodoApp.Broker.Frontend.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable CreatedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CreatedAtUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public TodoApp.Broker.Frontend.Models.TodoDescription.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Broker.Frontend.Models.TodoDescription.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>dueDate</c> property.
        /// </summary>
        public TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable DueDate
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DueDateUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonUuid.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Broker.Frontend.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.TodoPriority.Mutable Priority
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out TodoApp.Broker.Frontend.Models.TodoPriority.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.TodoStatus.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Frontend.Models.TodoStatus.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public TodoApp.Broker.Frontend.Models.TodoTags.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out TodoApp.Broker.Frontend.Models.TodoTags.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.TodoTitle.Mutable Title
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out TodoApp.Broker.Frontend.Models.TodoTitle.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable UpdatedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdatedAtUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TodoItem(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>assignee</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAssignee(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AssigneeUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AssigneeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Assignee, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>assignee</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveAssignee()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AssigneeUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCreatedAt(in TodoApp.Broker.Frontend.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDescription(in TodoApp.Broker.Frontend.Models.TodoDescription.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>dueDate</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDueDate(in TodoApp.Broker.Frontend.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DueDateUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DueDateUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DueDate, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>dueDate</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveDueDate()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DueDateUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(in TodoApp.Broker.Frontend.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPriority(in TodoApp.Broker.Frontend.Models.TodoPriority.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.Frontend.Models.TodoStatus.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in TodoApp.Broker.Frontend.Models.TodoTags.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in TodoApp.Broker.Frontend.Models.TodoTags.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTitle(in TodoApp.Broker.Frontend.Models.TodoTitle.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUpdatedAt(in TodoApp.Broker.Frontend.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TodoItem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TodoItem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly TodoItem Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TodoItem>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TodoItem"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly TodoItem Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoItem>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.TodoItem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TodoItem instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.TodoItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="TodoItem"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source createdAt,
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source id,
            in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority,
            in TodoApp.Broker.Frontend.Models.TodoStatus.Source status,
            in TodoApp.Broker.Frontend.Models.TodoTitle.Source title,
            in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default,
            in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default,
            in TodoApp.Broker.Frontend.Models.TodoTags.Source tags = default,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source updatedAt = default)
        {
            ...
            assignee.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Assignee, ref builder);
            description.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Description, ref builder);
            dueDate.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DueDate, ref builder);
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source updatedAt = default)
        {
            Create(ref _builder, createdAt, id, priority, status, title, assignee, description, dueDate, tags, updatedAt);
        }
        ...
        internal static void Create<TContext>(
            ...
            in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default,
            in TodoApp.Broker.Frontend.Models.TodoTags.Source<TContext> tags = default,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source updatedAt = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, createdAt, id, priority, status, title, assignee, description, dueDate, tags, updatedAt);
        }
    ...
    /// <param name="assignee">The value of the property.</param>
    /// <param name="description">The value of the property.</param>
    /// <param name="dueDate">The value of the property.</param>
    /// <param name="tags">The value of the property.</param>
    /// <param name="updatedAt">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source createdAt, in TodoApp.Broker.Frontend.Models.JsonUuid.Source id, in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority, in TodoApp.Broker.Frontend.Models.TodoStatus.Source status, in TodoApp.Broker.Frontend.Models.TodoTitle.Source title, in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default, in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default, in TodoApp.Broker.Frontend.Models.TodoTags.Source tags = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source updatedAt = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(createdAt, id, priority, status, title, assignee, description, dueDate, tags, updatedAt);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source createdAt, in TodoApp.Broker.Frontend.Models.JsonUuid.Source id, in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority, in TodoApp.Broker.Frontend.Models.TodoStatus.Source status, in TodoApp.Broker.Frontend.Models.TodoTitle.Source title, in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default, in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default, in TodoApp.Broker.Frontend.Models.TodoTags.Source<TContext> tags = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source updatedAt = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, createdAt, id, priority, status, title, assignee, description, dueDate, tags, updatedAt);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<TodoItem, Mutable>(this);
    }
}
