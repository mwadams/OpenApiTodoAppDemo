...
public readonly partial struct TodoTitle
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoTitle instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoTitle"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoTitle(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoTitle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TodoTitle Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TodoTitle Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoTitle>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TodoTitle instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<TodoTitle, Mutable>(this);
    }
}
