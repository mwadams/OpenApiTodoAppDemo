...
public readonly partial struct NewTodo
{
...
#endif
    {
        ...
        public static explicit operator Mutable(NewTodo instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NewTodo"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NewTodo(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NewTodo(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NewTodo.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NewTodo"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NewTodo"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly NewTodo Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NewTodo>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NewTodo"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly NewTodo Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NewTodo>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.NewTodo.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(NewTodo instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.NewTodo.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="NewTodo"/>.
        /// </summary>
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.TodoTags.Source tags = default)
        {
            Create(ref _builder, title, assignee, description, dueDate, priority, status, tags);
        }
        ...
        #endif
        {
            Create(context, ref _builder, title, assignee, description, dueDate, priority, status, tags);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.TodoTitle.Source title, in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default, in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default, in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority = default, in TodoApp.Broker.Frontend.Models.TodoStatus.Source status = default, in TodoApp.Broker.Frontend.Models.TodoTags.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(title, assignee, description, dueDate, priority, status, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.Frontend.Models.TodoTitle.Source title, in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default, in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default, in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority = default, in TodoApp.Broker.Frontend.Models.TodoStatus.Source status = default, in TodoApp.Broker.Frontend.Models.TodoTags.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, title, assignee, description, dueDate, priority, status, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<NewTodo, Mutable>(this);
    }
}
