...
public readonly partial struct TodoUpdate
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TodoUpdate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TodoUpdate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TodoUpdate(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TodoUpdate(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TodoUpdate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TodoUpdate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TodoUpdate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly TodoUpdate Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TodoUpdate>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TodoUpdate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly TodoUpdate Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TodoUpdate>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.TodoUpdate.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TodoUpdate instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.TodoUpdate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="TodoUpdate"/>.
        /// </summary>
        internal static void Create(
            ...
            in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority = default,
            in TodoApp.Broker.Frontend.Models.TodoStatus.Source status = default,
            in TodoApp.Broker.Frontend.Models.TodoTags.Source tags = default,
            in TodoApp.Broker.Frontend.Models.TodoTitle.Source title = default)
        {
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.TodoTitle.Source title = default)
        {
            Create(ref _builder, assignee, description, dueDate, priority, status, tags, title);
        }
        ...
        #endif
        {
            Create(context, ref _builder, assignee, description, dueDate, priority, status, tags, title);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default, in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default, in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority = default, in TodoApp.Broker.Frontend.Models.TodoStatus.Source status = default, in TodoApp.Broker.Frontend.Models.TodoTags.Source tags = default, in TodoApp.Broker.Frontend.Models.TodoTitle.Source title = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(assignee, description, dueDate, priority, status, tags, title);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.Frontend.Models.JsonString.Source assignee = default, in TodoApp.Broker.Frontend.Models.TodoDescription.Source description = default, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source dueDate = default, in TodoApp.Broker.Frontend.Models.TodoPriority.Source priority = default, in TodoApp.Broker.Frontend.Models.TodoStatus.Source status = default, in TodoApp.Broker.Frontend.Models.TodoTags.Source<TContext> tags = default, in TodoApp.Broker.Frontend.Models.TodoTitle.Source title = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, assignee, description, dueDate, priority, status, tags, title);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<TodoUpdate, Mutable>(this);
    }
}
