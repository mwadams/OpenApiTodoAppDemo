...
public readonly partial struct AuthRegister
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AuthRegister instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AuthRegister"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AuthRegister(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.AuthRegister.PasswordEntity.Mutable Password
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out TodoApp.Broker.Frontend.Models.AuthRegister.PasswordEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AuthRegister(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPassword(in TodoApp.Broker.Frontend.Models.AuthRegister.PasswordEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AuthRegister.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AuthRegister"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AuthRegister"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AuthRegister Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AuthRegister>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AuthRegister"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AuthRegister Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AuthRegister>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.AuthRegister.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(AuthRegister instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.AuthRegister.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AuthRegister"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonEmail.Source email,
            in TodoApp.Broker.Frontend.Models.AuthRegister.PasswordEntity.Source password,
            in TodoApp.Broker.Frontend.Models.JsonString.Source displayName = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email, in TodoApp.Broker.Frontend.Models.AuthRegister.PasswordEntity.Source password, in TodoApp.Broker.Frontend.Models.JsonString.Source displayName = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<AuthRegister, Mutable>(this);
    }
}
