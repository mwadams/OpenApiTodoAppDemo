...
public readonly partial struct OrganizationMember
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OrganizationMember instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OrganizationMember"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OrganizationMember(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>joinedAt</c> property.
        /// </summary>
        public TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable JoinedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JoinedAtUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonUuid.Mutable OrgId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out TodoApp.Broker.Frontend.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>provisioningTicket</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Ticket ID for polling provisioning status of the member&#39;s org storage.
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonUuid.Mutable ProvisioningTicket
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisioningTicketUtf8, out TodoApp.Broker.Frontend.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.OrganizationMember.RoleEntity.Mutable Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Broker.Frontend.Models.OrganizationMember.RoleEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonUuid.Mutable UserId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Broker.Frontend.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OrganizationMember(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>joinedAt</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetJoinedAt(in TodoApp.Broker.Frontend.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.JoinedAtUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JoinedAtUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.JoinedAt, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>joinedAt</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveJoinedAt()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.JoinedAtUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrgId(in TodoApp.Broker.Frontend.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>provisioningTicket</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProvisioningTicket(in TodoApp.Broker.Frontend.Models.JsonUuid.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvisioningTicketUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisioningTicketUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ProvisioningTicket, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>provisioningTicket</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveProvisioningTicket()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvisioningTicketUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRole(in TodoApp.Broker.Frontend.Models.OrganizationMember.RoleEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUserId(in TodoApp.Broker.Frontend.Models.JsonUuid.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("userId");
            }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OrganizationMember.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OrganizationMember"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OrganizationMember"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMember Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OrganizationMember>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OrganizationMember"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMember Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OrganizationMember>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.OrganizationMember.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(OrganizationMember instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.OrganizationMember.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="OrganizationMember"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source orgId,
            in TodoApp.Broker.Frontend.Models.OrganizationMember.RoleEntity.Source role,
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source userId,
            in TodoApp.Broker.Frontend.Models.JsonDateTime.Source joinedAt = default,
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source provisioningTicket = default)
        {
            ...
            joinedAt.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.JoinedAt, ref builder);
            provisioningTicket.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ProvisioningTicket, ref builder);
        }
        ...
        public void Create(
            ...
            in TodoApp.Broker.Frontend.Models.JsonUuid.Source provisioningTicket = default)
        {
            Create(ref _builder, orgId, role, userId, joinedAt, provisioningTicket);
        }
    ...
    /// <param name="joinedAt">The value of the property.</param>
    /// <param name="provisioningTicket">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonUuid.Source orgId, in TodoApp.Broker.Frontend.Models.OrganizationMember.RoleEntity.Source role, in TodoApp.Broker.Frontend.Models.JsonUuid.Source userId, in TodoApp.Broker.Frontend.Models.JsonDateTime.Source joinedAt = default, in TodoApp.Broker.Frontend.Models.JsonUuid.Source provisioningTicket = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(orgId, role, userId, joinedAt, provisioningTicket);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<OrganizationMember, Mutable>(this);
    }
}
