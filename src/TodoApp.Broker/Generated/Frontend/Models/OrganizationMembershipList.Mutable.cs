...
public readonly partial struct OrganizationMembershipList
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OrganizationMembershipList instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OrganizationMembershipList"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OrganizationMembershipList(Mutable instance)
        {
        ...
        public TodoApp.Broker.Frontend.Models.OrganizationMembership.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Broker.Frontend.Models.OrganizationMembership.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Broker.Frontend.Models.OrganizationMembership.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.OrganizationMembership.Mutable>(_parent, _idx);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OrganizationMembershipList(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OrganizationMembershipList.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        /// <summary>
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in TodoApp.Broker.Frontend.Models.OrganizationMembership.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in TodoApp.Broker.Frontend.Models.OrganizationMembership.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in TodoApp.Broker.Frontend.Models.OrganizationMembership.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in TodoApp.Broker.Frontend.Models.OrganizationMembership item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Broker.Frontend.Models.OrganizationMembership>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<TodoApp.Broker.Frontend.Models.OrganizationMembership> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Broker.Frontend.Models.OrganizationMembership>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in TodoApp.Broker.Frontend.Models.OrganizationMembership oldItem, in TodoApp.Broker.Frontend.Models.OrganizationMembership.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Broker.Frontend.Models.OrganizationMembership>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                TodoApp.Broker.Frontend.Models.OrganizationMembership current = enumerator.Current;
        ...
        /// <summary>
        /// Gets a <see cref="OrganizationMembershipList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OrganizationMembershipList"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMembershipList Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OrganizationMembershipList>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OrganizationMembershipList"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMembershipList Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OrganizationMembershipList>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(OrganizationMembershipList instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.OrganizationMembershipList.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
    ...
    {
        return workspace.CreateBuilder<OrganizationMembershipList, Mutable>(this);
    }
}
