...
#endif
{
    ...
    internal TodoItem(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TodoItem DefaultInstance { get; }
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.JsonString Assignee
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AssigneeUtf8, out TodoApp.Broker.Frontend.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.JsonDateTime CreatedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CreatedAtUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.TodoDescription Description
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Broker.Frontend.Models.TodoDescription value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.JsonDateTime DueDate
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DueDateUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.JsonUuid Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Broker.Frontend.Models.JsonUuid value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.TodoPriority Priority
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PriorityUtf8, out TodoApp.Broker.Frontend.Models.TodoPriority value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.TodoStatus Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.Frontend.Models.TodoStatus value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.TodoTags Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out TodoApp.Broker.Frontend.Models.TodoTags value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.Frontend.Models.TodoTitle Title
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out TodoApp.Broker.Frontend.Models.TodoTitle value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Broker.Frontend.Models.JsonDateTime UpdatedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdatedAtUtf8, out TodoApp.Broker.Frontend.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in TodoItem left, in TodoItem right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TodoItem left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TodoItem instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TodoItem(JsonElement instance)
    {
        return TodoItem.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TodoItem From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TodoItem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TodoItem>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TodoItem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TodoItem>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TodoItem ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TodoItem>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static TodoItem ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TodoItem>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TodoItem? result)
    {
        return JsonElementHelpers.TryParseValue<TodoItem>(ref reader, out result);
    }
...
#if NET
    static TodoItem IJsonElement<TodoItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TodoItem: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Assignee"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="DueDate"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Assignee"/>.
        /// </summary>
        public static ReadOnlySpan<byte> AssigneeUtf8 => "assignee"u8;
        ...
        /// Gets the JSON property name for <see cref="DueDate"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DueDateUtf8 => "dueDate"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Assignee"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Assignee => "assignee"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="DueDate"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DueDate => "dueDate"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Assignee"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Assignee => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6E, 0x65, 0x65, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="DueDate"/>.
        /// </summary>
        public static ReadOnlySpan<byte> DueDate => [0x95, 0x00, 0x00, 0x00, 0x22, 0x64, 0x75, 0x65, 0x44, 0x61, 0x74, 0x65, 0x22];
