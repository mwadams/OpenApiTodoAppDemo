...
public readonly partial struct AuthLogin
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AuthLogin instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AuthLogin"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AuthLogin(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.Frontend.Models.JsonString.Mutable Password
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out TodoApp.Broker.Frontend.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AuthLogin(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPassword(in TodoApp.Broker.Frontend.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AuthLogin.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AuthLogin"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AuthLogin"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AuthLogin Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AuthLogin>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AuthLogin"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AuthLogin Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AuthLogin>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.Frontend.Models.AuthLogin.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(AuthLogin instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.Frontend.Models.AuthLogin.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AuthLogin"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.Frontend.Models.JsonEmail.Source email,
            in TodoApp.Broker.Frontend.Models.JsonString.Source password)
        {
        ...
        /// Creates an instance of a <see cref="AuthLogin"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.Frontend.Models.JsonEmail.Source email, in TodoApp.Broker.Frontend.Models.JsonString.Source password)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.Frontend.Models.JsonEmail.Source email, in TodoApp.Broker.Frontend.Models.JsonString.Source password, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<AuthLogin, Mutable>(this);
    }
}
