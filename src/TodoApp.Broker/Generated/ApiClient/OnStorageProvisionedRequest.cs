...
/// <summary>
/// Request type for the OnStorageProvisioned operation.
/// </summary>
/// <remarks>Callback endpoint for storage provisioning notifications</remarks>
public readonly struct OnStorageProvisionedRequest : IApiRequest<OnStorageProvisionedRequest>
{

    /// <inheritdoc/>
    public static ReadOnlySpan<byte> PathTemplateUtf8 => "/callbacks/storage-provisioned"u8;
