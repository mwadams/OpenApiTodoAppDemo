...
public readonly partial struct OrganizationStorageProvisioned
{
        ...
        : IJsonElement<EntityTypeEntity>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Const = "organization"u8.ToArray();
            /// <summary>
            /// A constant for the <c>const</c> keyword.
            /// </summary>
            public static readonly EntityTypeEntity ConstJson = ParsedJsonDocument<EntityTypeEntity>.StringConstant([.."\"organization\""u8]);
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/OrganizationStorageProvisioned/properties/entityType"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/OrganizationStorageProvisioned/properties/entityType";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/OrganizationStorageProvisioned/properties/entityType"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "organization"u8, "organization", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "organization", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
