...
public readonly partial struct UserStorageProvisioned
{
        ...
        : IJsonElement<EntityTypeEntity>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Const = "user"u8.ToArray();
            /// <summary>
            /// A constant for the <c>const</c> keyword.
            /// </summary>
            public static readonly EntityTypeEntity ConstJson = ParsedJsonDocument<EntityTypeEntity>.StringConstant([.."\"user\""u8]);
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/UserStorageProvisioned/properties/entityType"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/UserStorageProvisioned/properties/entityType";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/UserStorageProvisioned/properties/entityType"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchStringConstantValue(unescapedUtf8JsonString.Span, "user"u8, "user", "const"u8, ref context);
                }
                else
                {
                    context.EvaluatedKeyword(false, "user", messageProvider: JsonSchemaEvaluation.ExpectedStringEquals, "const"u8);
                }
            }
