...
public readonly partial struct NewOrganization
{
    ...
    public readonly partial struct DisplayNameForTheOrganization
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DisplayNameForTheOrganization instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DisplayNameForTheOrganization"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisplayNameForTheOrganization(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisplayNameForTheOrganization.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DisplayNameForTheOrganization Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DisplayNameForTheOrganization Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DisplayNameForTheOrganization>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DisplayNameForTheOrganization instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DisplayNameForTheOrganization, Mutable>(this);
        }
    }
}
