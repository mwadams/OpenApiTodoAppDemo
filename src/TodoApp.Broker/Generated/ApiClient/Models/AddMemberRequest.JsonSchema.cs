    ...
    : IJsonElement<AddMemberRequest>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForUserId = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForUserId;
        ...
        private static void MatchRole(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchUserId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            TodoApp.Broker.ApiClient.Models.JsonUuid.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/AddMemberRequest"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/AddMemberRequest";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/AddMemberRequest"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUserIdPresent, "userId"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyUserIdNotPresent, "userId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUserIdPresent, "userId"u8, "required"u8);
