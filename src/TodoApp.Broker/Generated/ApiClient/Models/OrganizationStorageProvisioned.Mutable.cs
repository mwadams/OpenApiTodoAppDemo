...
public readonly partial struct OrganizationStorageProvisioned
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OrganizationStorageProvisioned instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OrganizationStorageProvisioned"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OrganizationStorageProvisioned(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// Unique identifier of the newly provisioned organization
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.EntityTypeEntity.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.EntityTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// The original organization creation request, echoed back so the stateless API can populate storage
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.NewOrganization.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Broker.ApiClient.Models.NewOrganization.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// SAS token granting write access to the organization&#39;s newly provisioned blob storage
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OrganizationStorageProvisioned(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.EntityTypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload(in TodoApp.Broker.ApiClient.Models.NewOrganization.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in TodoApp.Broker.ApiClient.Models.NewOrganization.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OrganizationStorageProvisioned.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OrganizationStorageProvisioned"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OrganizationStorageProvisioned"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationStorageProvisioned Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OrganizationStorageProvisioned>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OrganizationStorageProvisioned"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationStorageProvisioned Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OrganizationStorageProvisioned>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(OrganizationStorageProvisioned instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="OrganizationStorageProvisioned"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.NewOrganization.Source payload,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        {
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.EntityTypeEntity.ConstInstance);
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.StatusEntity.ConstInstance);
        }
        ...
        public void Create(
            ...
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        {
            Create(ref _builder, entityId, payload, sasToken);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.NewOrganization.Source<TContext> payload,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, entityId, payload, sasToken);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.NewOrganization.Source payload, in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(entityId, payload, sasToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.NewOrganization.Source<TContext> payload, in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, entityId, payload, sasToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<OrganizationStorageProvisioned, Mutable>(this);
    }
}
