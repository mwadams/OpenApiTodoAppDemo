...
public readonly partial struct AddMemberRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AddMemberRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AddMemberRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AddMemberRequest(Mutable instance)
        {
        ...
        /// </summary>
        public TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.Mutable Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.JsonUuid.Mutable UserId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Broker.ApiClient.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AddMemberRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetRole(in TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUserId(in TodoApp.Broker.ApiClient.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AddMemberRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AddMemberRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AddMemberRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly AddMemberRequest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AddMemberRequest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AddMemberRequest"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly AddMemberRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AddMemberRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.AddMemberRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(AddMemberRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.AddMemberRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AddMemberRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source userId,
            in TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.Source role = default)
        {
        ...
        /// Creates an instance of a <see cref="AddMemberRequest"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.ApiClient.Models.JsonUuid.Source userId, in TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.Source role = default)
        {
            Create(ref _builder, userId, role);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source userId, in TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.Source role = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(userId, role);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<AddMemberRequest, Mutable>(this);
    }
}
