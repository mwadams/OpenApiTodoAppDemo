...
public readonly partial struct NewOrganization
{
    ...
    public readonly partial struct OptionalDescriptionOfTheOrganizationSPurpose
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OptionalDescriptionOfTheOrganizationSPurpose instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OptionalDescriptionOfTheOrganizationSPurpose"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionalDescriptionOfTheOrganizationSPurpose(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionalDescriptionOfTheOrganizationSPurpose.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly OptionalDescriptionOfTheOrganizationSPurpose Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly OptionalDescriptionOfTheOrganizationSPurpose Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OptionalDescriptionOfTheOrganizationSPurpose>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(OptionalDescriptionOfTheOrganizationSPurpose instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<OptionalDescriptionOfTheOrganizationSPurpose, Mutable>(this);
        }
    }
}
