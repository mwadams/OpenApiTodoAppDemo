...
public readonly partial struct StorageProvisioningFailed
{
...
#endif
    {
        ...
        public static explicit operator Mutable(StorageProvisioningFailed instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StorageProvisioningFailed"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StorageProvisioningFailed(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// Unique identifier of the entity whose provisioning failed
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// <para>
        /// The kind of entity whose provisioning failed
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Broker.ApiClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new StorageProvisioningFailed(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in TodoApp.Broker.ApiClient.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StorageProvisioningFailed.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="StorageProvisioningFailed"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="StorageProvisioningFailed"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly StorageProvisioningFailed Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<StorageProvisioningFailed>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="StorageProvisioningFailed"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly StorageProvisioningFailed Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<StorageProvisioningFailed>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(StorageProvisioningFailed instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="StorageProvisioningFailed"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Source entityType,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source message = default)
        {
            entityId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntityId, ref builder);
            entityType.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.StatusEntity.ConstInstance);
        ...
        public void Create(
            ...
            in TodoApp.Broker.ApiClient.Models.JsonString.Source message = default)
        {
            Create(ref _builder, entityId, entityType, message);
        }
    ...
    /// <param name="entityType">The value of the property.</param>
    /// <param name="message">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Source entityType, in TodoApp.Broker.ApiClient.Models.JsonString.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(entityId, entityType, message);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<StorageProvisioningFailed, Mutable>(this);
    }
}
