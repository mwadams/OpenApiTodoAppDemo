...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AddMemberRequest"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal AddMemberRequest(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static AddMemberRequest DefaultInstance { get; }
    ...
    /// </summary>
    public TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity Role
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity value))
            {
                return value;
            }

            return TodoApp.Broker.ApiClient.Models.AddMemberRequest.RoleEntity.DefaultInstance;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.JsonUuid UserId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Broker.ApiClient.Models.JsonUuid value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in AddMemberRequest left, in AddMemberRequest right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in AddMemberRequest left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(AddMemberRequest instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator AddMemberRequest(JsonElement instance)
    {
        return AddMemberRequest.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AddMemberRequest From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AddMemberRequest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AddMemberRequest>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AddMemberRequest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AddMemberRequest>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AddMemberRequest ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AddMemberRequest>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static AddMemberRequest ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<AddMemberRequest>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out AddMemberRequest? result)
    {
        return JsonElementHelpers.TryParseValue<AddMemberRequest>(ref reader, out result);
    }
...
#if NET
    static AddMemberRequest IJsonElement<AddMemberRequest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"AddMemberRequest: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public AddMemberRequest Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AddMemberRequest>(_idx);
        }
