...
public readonly partial struct NewOrganization
{
...
#endif
    {
        ...
        public static explicit operator Mutable(NewOrganization instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NewOrganization"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NewOrganization(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Broker.ApiClient.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.NewOrganization.DisplayNameForTheOrganization.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Broker.ApiClient.Models.NewOrganization.DisplayNameForTheOrganization.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NewOrganization(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDescription(in TodoApp.Broker.ApiClient.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(in TodoApp.Broker.ApiClient.Models.NewOrganization.DisplayNameForTheOrganization.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NewOrganization.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NewOrganization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NewOrganization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly NewOrganization Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NewOrganization>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NewOrganization"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly NewOrganization Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NewOrganization>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.NewOrganization.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(NewOrganization instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.NewOrganization.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="NewOrganization"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.NewOrganization.DisplayNameForTheOrganization.Source name,
            in TodoApp.Broker.ApiClient.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source description = default)
        {
        ...
        /// Creates an instance of a <see cref="NewOrganization"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.ApiClient.Models.NewOrganization.DisplayNameForTheOrganization.Source name, in TodoApp.Broker.ApiClient.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source description = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.NewOrganization.DisplayNameForTheOrganization.Source name, in TodoApp.Broker.ApiClient.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<NewOrganization, Mutable>(this);
    }
}
