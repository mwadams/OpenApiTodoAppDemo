...
public readonly partial struct NewUser
{
    ...
    public readonly partial struct HumanReadableDisplayNameForTheUser
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(HumanReadableDisplayNameForTheUser instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="HumanReadableDisplayNameForTheUser"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HumanReadableDisplayNameForTheUser(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HumanReadableDisplayNameForTheUser.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly HumanReadableDisplayNameForTheUser Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly HumanReadableDisplayNameForTheUser Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<HumanReadableDisplayNameForTheUser>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(HumanReadableDisplayNameForTheUser instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<HumanReadableDisplayNameForTheUser, Mutable>(this);
        }
    }
}
