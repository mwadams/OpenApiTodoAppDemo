...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UserStorageProvisioned"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal UserStorageProvisioned(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static UserStorageProvisioned DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.EntityTypeEntity EntityType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.EntityTypeEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.NewUser Payload
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Broker.ApiClient.Models.NewUser value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.StatusEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in UserStorageProvisioned left, in UserStorageProvisioned right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in UserStorageProvisioned left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(UserStorageProvisioned instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator UserStorageProvisioned(JsonElement instance)
    {
        return UserStorageProvisioned.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserStorageProvisioned From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserStorageProvisioned ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UserStorageProvisioned>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserStorageProvisioned ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UserStorageProvisioned>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserStorageProvisioned ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UserStorageProvisioned>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static UserStorageProvisioned ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<UserStorageProvisioned>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out UserStorageProvisioned? result)
    {
        return JsonElementHelpers.TryParseValue<UserStorageProvisioned>(ref reader, out result);
    }
...
#if NET
    static UserStorageProvisioned IJsonElement<UserStorageProvisioned>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"UserStorageProvisioned: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public UserStorageProvisioned Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public UserStorageProvisioned Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<UserStorageProvisioned>(_idx);
        }
