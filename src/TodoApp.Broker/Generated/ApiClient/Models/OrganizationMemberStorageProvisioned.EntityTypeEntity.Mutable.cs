...
public readonly partial struct OrganizationMemberStorageProvisioned
{
    ...
    public readonly partial struct EntityTypeEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EntityTypeEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EntityTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EntityTypeEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EntityTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EntityTypeEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EntityTypeEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EntityTypeEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EntityTypeEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EntityTypeEntity, Mutable>(this);
        }
    }
}
