...
/// </summary>
public readonly partial struct NewUser
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    ...
    public readonly partial struct HumanReadableDisplayNameForTheUser
#if NET8_0_OR_GREATER
        : IJsonElement<HumanReadableDisplayNameForTheUser>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HumanReadableDisplayNameForTheUser"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal HumanReadableDisplayNameForTheUser(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static HumanReadableDisplayNameForTheUser DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(HumanReadableDisplayNameForTheUser value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in HumanReadableDisplayNameForTheUser left, in HumanReadableDisplayNameForTheUser right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in HumanReadableDisplayNameForTheUser left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(HumanReadableDisplayNameForTheUser instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator HumanReadableDisplayNameForTheUser(JsonElement instance)
        {
            return HumanReadableDisplayNameForTheUser.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HumanReadableDisplayNameForTheUser From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HumanReadableDisplayNameForTheUser ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<HumanReadableDisplayNameForTheUser>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HumanReadableDisplayNameForTheUser ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<HumanReadableDisplayNameForTheUser>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static HumanReadableDisplayNameForTheUser ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<HumanReadableDisplayNameForTheUser>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static HumanReadableDisplayNameForTheUser ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<HumanReadableDisplayNameForTheUser>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out HumanReadableDisplayNameForTheUser? result)
        {
            return JsonElementHelpers.TryParseValue<HumanReadableDisplayNameForTheUser>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new HumanReadableDisplayNameForTheUser(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static HumanReadableDisplayNameForTheUser IJsonElement<HumanReadableDisplayNameForTheUser>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"HumanReadableDisplayNameForTheUser: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="HumanReadableDisplayNameForTheUser"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="HumanReadableDisplayNameForTheUser"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public HumanReadableDisplayNameForTheUser Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<HumanReadableDisplayNameForTheUser>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="HumanReadableDisplayNameForTheUser"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public HumanReadableDisplayNameForTheUser Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<HumanReadableDisplayNameForTheUser>(_idx);
            }
