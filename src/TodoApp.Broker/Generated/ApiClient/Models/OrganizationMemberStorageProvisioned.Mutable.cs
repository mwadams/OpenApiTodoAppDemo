...
public readonly partial struct OrganizationMemberStorageProvisioned
{
...
#endif
    {
        ...
        public static explicit operator Mutable(OrganizationMemberStorageProvisioned instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="OrganizationMemberStorageProvisioned"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OrganizationMemberStorageProvisioned(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>entityId</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// Unique identifier of the user who is the member
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.JsonUuid.Mutable EntityId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityIdUtf8, out TodoApp.Broker.ApiClient.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>entityType</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.JsonUuid.Mutable OrgId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out TodoApp.Broker.ApiClient.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// The original add member request, echoed back
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.AddMemberRequest.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Broker.ApiClient.Models.AddMemberRequest.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>sasToken</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// <para>
        /// SAS token granting write access to the member&#39;s newly provisioned blob storage within the organization
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.JsonString.Mutable SasToken
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SasTokenUtf8, out TodoApp.Broker.ApiClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OrganizationMemberStorageProvisioned(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>entityId</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityId(in TodoApp.Broker.ApiClient.Models.JsonUuid.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("entityId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntityId, ref cvb);
        ...
        /// <summary>
        /// Set the <c>entityType</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("entityType");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Set the <c>orgId</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrgId(in TodoApp.Broker.ApiClient.Models.JsonUuid.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("orgId");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrgId, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload(in TodoApp.Broker.ApiClient.Models.AddMemberRequest.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in TodoApp.Broker.ApiClient.Models.AddMemberRequest.Source<TContext> value)
        ...
        /// <summary>
        /// Set the <c>sasToken</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSasToken(in TodoApp.Broker.ApiClient.Models.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("sasToken");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SasTokenUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SasToken, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OrganizationMemberStorageProvisioned.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OrganizationMemberStorageProvisioned"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OrganizationMemberStorageProvisioned"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMemberStorageProvisioned Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OrganizationMemberStorageProvisioned>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OrganizationMemberStorageProvisioned"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly OrganizationMemberStorageProvisioned Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<OrganizationMemberStorageProvisioned>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(OrganizationMemberStorageProvisioned instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="OrganizationMemberStorageProvisioned"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source orgId,
            in TodoApp.Broker.ApiClient.Models.AddMemberRequest.Source payload,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        {
            entityId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntityId, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.ConstInstance);
            orgId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrgId, ref builder);
            payload.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Payload, ref builder);
            sasToken.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SasToken, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.StatusEntity.ConstInstance);
        }
        ...
        public void Create(
            ...
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        {
            Create(ref _builder, entityId, orgId, payload, sasToken);
        }
        ...
        internal static void Create<TContext>(
            ...
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source orgId,
            in TodoApp.Broker.ApiClient.Models.AddMemberRequest.Source<TContext> payload,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        ...
        #endif
        {
            Create(context, ref _builder, entityId, orgId, payload, sasToken);
        }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="entityId">The value of the property.</param>
    /// <param name="orgId">The value of the property.</param>
    /// <param name="payload">The value of the property.</param>
    /// <param name="sasToken">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source orgId, in TodoApp.Broker.ApiClient.Models.AddMemberRequest.Source payload, in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(entityId, orgId, payload, sasToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source orgId, in TodoApp.Broker.ApiClient.Models.AddMemberRequest.Source<TContext> payload, in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, entityId, orgId, payload, sasToken);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<OrganizationMemberStorageProvisioned, Mutable>(this);
    }
}
