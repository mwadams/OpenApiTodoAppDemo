    ...
    : IJsonElement<ProvisioningNotification>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ProvisioningNotification"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ProvisioningNotification";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ProvisioningNotification"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext oneOfContext0 =
                TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
            TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
            ...
            JsonSchemaContext oneOfContext1 =
                TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
            TodoApp.Broker.ApiClient.Models.OrganizationStorageProvisioned.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
            ...
            JsonSchemaContext oneOfContext2 =
                TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
            TodoApp.Broker.ApiClient.Models.OrganizationMemberStorageProvisioned.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
            ...
            JsonSchemaContext oneOfContext3 =
                TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
            TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
