...
public readonly partial struct NewUser
{
...
#endif
    {
        ...
        public static explicit operator Mutable(NewUser instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="NewUser"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NewUser(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.NewUser.HumanReadableDisplayNameForTheUser.Mutable DisplayName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Broker.ApiClient.Models.NewUser.HumanReadableDisplayNameForTheUser.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.JsonEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Broker.ApiClient.Models.JsonEmail.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NewUser(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDisplayName(in TodoApp.Broker.ApiClient.Models.NewUser.HumanReadableDisplayNameForTheUser.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEmail(in TodoApp.Broker.ApiClient.Models.JsonEmail.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NewUser.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NewUser"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NewUser"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly NewUser Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NewUser>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NewUser"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly NewUser Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NewUser>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.NewUser.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(NewUser instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.NewUser.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="NewUser"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.NewUser.HumanReadableDisplayNameForTheUser.Source displayName,
            in TodoApp.Broker.ApiClient.Models.JsonEmail.Source email = default)
        {
        ...
        /// Creates an instance of a <see cref="NewUser"/>.
        /// </summary>
        public void Create(in TodoApp.Broker.ApiClient.Models.NewUser.HumanReadableDisplayNameForTheUser.Source displayName, in TodoApp.Broker.ApiClient.Models.JsonEmail.Source email = default)
        {
            Create(ref _builder, displayName, email);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.NewUser.HumanReadableDisplayNameForTheUser.Source displayName, in TodoApp.Broker.ApiClient.Models.JsonEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(displayName, email);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<NewUser, Mutable>(this);
    }
}
