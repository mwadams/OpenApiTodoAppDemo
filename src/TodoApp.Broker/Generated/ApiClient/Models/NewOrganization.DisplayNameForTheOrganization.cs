...
public readonly partial struct NewOrganization
{
    ...
    public readonly partial struct DisplayNameForTheOrganization
#if NET8_0_OR_GREATER
        : IJsonElement<DisplayNameForTheOrganization>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayNameForTheOrganization"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DisplayNameForTheOrganization(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DisplayNameForTheOrganization DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(DisplayNameForTheOrganization value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in DisplayNameForTheOrganization left, in DisplayNameForTheOrganization right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DisplayNameForTheOrganization left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DisplayNameForTheOrganization instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DisplayNameForTheOrganization(JsonElement instance)
        {
            return DisplayNameForTheOrganization.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisplayNameForTheOrganization From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisplayNameForTheOrganization ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DisplayNameForTheOrganization>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisplayNameForTheOrganization ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DisplayNameForTheOrganization>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisplayNameForTheOrganization ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DisplayNameForTheOrganization>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DisplayNameForTheOrganization ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DisplayNameForTheOrganization>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DisplayNameForTheOrganization? result)
        {
            return JsonElementHelpers.TryParseValue<DisplayNameForTheOrganization>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DisplayNameForTheOrganization(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DisplayNameForTheOrganization IJsonElement<DisplayNameForTheOrganization>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DisplayNameForTheOrganization: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DisplayNameForTheOrganization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DisplayNameForTheOrganization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DisplayNameForTheOrganization Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DisplayNameForTheOrganization>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DisplayNameForTheOrganization"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DisplayNameForTheOrganization Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DisplayNameForTheOrganization>(_idx);
            }
