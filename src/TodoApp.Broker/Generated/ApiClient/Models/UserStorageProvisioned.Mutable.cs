...
public readonly partial struct UserStorageProvisioned
{
...
#endif
    {
        ...
        public static explicit operator Mutable(UserStorageProvisioned instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="UserStorageProvisioned"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UserStorageProvisioned(Mutable instance)
        {
        ...
        /// </para>
        /// <para>
        /// Unique identifier of the newly provisioned user
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.EntityTypeEntity.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.EntityTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// The original user creation request, echoed back so the stateless API can populate storage
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.NewUser.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Broker.ApiClient.Models.NewUser.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// SAS token granting write access to the user&#39;s newly provisioned blob storage
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UserStorageProvisioned(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.EntityTypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload(in TodoApp.Broker.ApiClient.Models.NewUser.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in TodoApp.Broker.ApiClient.Models.NewUser.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UserStorageProvisioned.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="UserStorageProvisioned"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="UserStorageProvisioned"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly UserStorageProvisioned Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<UserStorageProvisioned>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="UserStorageProvisioned"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly UserStorageProvisioned Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<UserStorageProvisioned>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(UserStorageProvisioned instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="UserStorageProvisioned"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.NewUser.Source payload,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        {
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.EntityTypeEntity.ConstInstance);
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Broker.ApiClient.Models.UserStorageProvisioned.StatusEntity.ConstInstance);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId,
            in TodoApp.Broker.ApiClient.Models.NewUser.Source<TContext> payload,
            in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.NewUser.Source payload, in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Broker.ApiClient.Models.JsonUuid.Source entityId, in TodoApp.Broker.ApiClient.Models.NewUser.Source<TContext> payload, in TodoApp.Broker.ApiClient.Models.JsonString.Source sasToken, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<UserStorageProvisioned, Mutable>(this);
    }
}
