    ...
    : IJsonElement<ProblemDetails>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchDetail(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            TodoApp.Broker.ApiClient.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchInstance(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                TodoApp.Broker.ApiClient.Models.JsonUri.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.ApiClient.Models.JsonUri.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                TodoApp.Broker.ApiClient.Models.JsonInt32.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Broker.ApiClient.Models.JsonInt32.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            TodoApp.Broker.ApiClient.Models.JsonUri.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
