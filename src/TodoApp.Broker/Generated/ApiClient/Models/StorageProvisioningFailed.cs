...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StorageProvisioningFailed"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StorageProvisioningFailed(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StorageProvisioningFailed DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed EntityType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Broker.ApiClient.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Broker.ApiClient.Models.StorageProvisioningFailed.StatusEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in StorageProvisioningFailed left, in StorageProvisioningFailed right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StorageProvisioningFailed left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StorageProvisioningFailed instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator StorageProvisioningFailed(JsonElement instance)
    {
        return StorageProvisioningFailed.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StorageProvisioningFailed From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StorageProvisioningFailed ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<StorageProvisioningFailed>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StorageProvisioningFailed ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<StorageProvisioningFailed>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StorageProvisioningFailed ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<StorageProvisioningFailed>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static StorageProvisioningFailed ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<StorageProvisioningFailed>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out StorageProvisioningFailed? result)
    {
        return JsonElementHelpers.TryParseValue<StorageProvisioningFailed>(ref reader, out result);
    }
...
#if NET
    static StorageProvisioningFailed IJsonElement<StorageProvisioningFailed>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StorageProvisioningFailed: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public StorageProvisioningFailed Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public StorageProvisioningFailed Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<StorageProvisioningFailed>(_idx);
        }
