...
/// </summary>
public readonly partial struct NewOrganization
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    ...
    public readonly partial struct OptionalDescriptionOfTheOrganizationSPurpose
#if NET8_0_OR_GREATER
        : IJsonElement<OptionalDescriptionOfTheOrganizationSPurpose>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionalDescriptionOfTheOrganizationSPurpose"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OptionalDescriptionOfTheOrganizationSPurpose(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OptionalDescriptionOfTheOrganizationSPurpose DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(OptionalDescriptionOfTheOrganizationSPurpose value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in OptionalDescriptionOfTheOrganizationSPurpose left, in OptionalDescriptionOfTheOrganizationSPurpose right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OptionalDescriptionOfTheOrganizationSPurpose left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(OptionalDescriptionOfTheOrganizationSPurpose instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OptionalDescriptionOfTheOrganizationSPurpose(JsonElement instance)
        {
            return OptionalDescriptionOfTheOrganizationSPurpose.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OptionalDescriptionOfTheOrganizationSPurpose From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OptionalDescriptionOfTheOrganizationSPurpose ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OptionalDescriptionOfTheOrganizationSPurpose>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OptionalDescriptionOfTheOrganizationSPurpose ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OptionalDescriptionOfTheOrganizationSPurpose>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OptionalDescriptionOfTheOrganizationSPurpose ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OptionalDescriptionOfTheOrganizationSPurpose>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static OptionalDescriptionOfTheOrganizationSPurpose ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OptionalDescriptionOfTheOrganizationSPurpose>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OptionalDescriptionOfTheOrganizationSPurpose? result)
        {
            return JsonElementHelpers.TryParseValue<OptionalDescriptionOfTheOrganizationSPurpose>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OptionalDescriptionOfTheOrganizationSPurpose(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OptionalDescriptionOfTheOrganizationSPurpose IJsonElement<OptionalDescriptionOfTheOrganizationSPurpose>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OptionalDescriptionOfTheOrganizationSPurpose: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OptionalDescriptionOfTheOrganizationSPurpose"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OptionalDescriptionOfTheOrganizationSPurpose"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OptionalDescriptionOfTheOrganizationSPurpose Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OptionalDescriptionOfTheOrganizationSPurpose>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OptionalDescriptionOfTheOrganizationSPurpose"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OptionalDescriptionOfTheOrganizationSPurpose Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OptionalDescriptionOfTheOrganizationSPurpose>(_idx);
            }
