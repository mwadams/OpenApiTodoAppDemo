...
public readonly partial struct StorageProvisioningFailed
{
    ...
    public readonly partial struct TheKindOfEntityWhoseProvisioningFailed
#if NET8_0_OR_GREATER
        : IJsonElement<TheKindOfEntityWhoseProvisioningFailed>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheKindOfEntityWhoseProvisioningFailed"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheKindOfEntityWhoseProvisioningFailed(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheKindOfEntityWhoseProvisioningFailed DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheKindOfEntityWhoseProvisioningFailed value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheKindOfEntityWhoseProvisioningFailed left, in TheKindOfEntityWhoseProvisioningFailed right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheKindOfEntityWhoseProvisioningFailed left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheKindOfEntityWhoseProvisioningFailed instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheKindOfEntityWhoseProvisioningFailed(JsonElement instance)
        {
            return TheKindOfEntityWhoseProvisioningFailed.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheKindOfEntityWhoseProvisioningFailed From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheKindOfEntityWhoseProvisioningFailed ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheKindOfEntityWhoseProvisioningFailed>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheKindOfEntityWhoseProvisioningFailed ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheKindOfEntityWhoseProvisioningFailed>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheKindOfEntityWhoseProvisioningFailed ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheKindOfEntityWhoseProvisioningFailed>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheKindOfEntityWhoseProvisioningFailed ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheKindOfEntityWhoseProvisioningFailed>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheKindOfEntityWhoseProvisioningFailed? result)
        {
            return JsonElementHelpers.TryParseValue<TheKindOfEntityWhoseProvisioningFailed>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheKindOfEntityWhoseProvisioningFailed(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheKindOfEntityWhoseProvisioningFailed IJsonElement<TheKindOfEntityWhoseProvisioningFailed>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheKindOfEntityWhoseProvisioningFailed: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheKindOfEntityWhoseProvisioningFailed"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheKindOfEntityWhoseProvisioningFailed"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheKindOfEntityWhoseProvisioningFailed Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheKindOfEntityWhoseProvisioningFailed>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheKindOfEntityWhoseProvisioningFailed"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheKindOfEntityWhoseProvisioningFailed Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheKindOfEntityWhoseProvisioningFailed>(_idx);
            }
        ...
        /// <param name="matchOrganization">Match 2nd item.</param>
        /// <param name="matchOrganizationMember">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchUser,
            Func<TContext, TResult> matchOrganization,
            Func<TContext, TResult> matchOrganizationMember,
...
#endif
        {
            ...
            {
                return matchOrganization(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchOrganizationMember(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchOrganization,
            Func<TResult> matchOrganizationMember,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchOrganizationMember();
            }
