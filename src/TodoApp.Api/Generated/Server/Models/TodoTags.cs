...
#endif
{
    ...
    public TodoApp.Api.Server.Models.JsonString this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<TodoApp.Api.Server.Models.JsonString>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<TodoApp.Api.Server.Models.JsonString> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Server.Models.JsonString>(_parent, _idx);
    }
