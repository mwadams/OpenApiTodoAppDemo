...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose Description
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Api.Server.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.NewOrganization.DisplayNameForTheOrganization Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Api.Server.Models.NewOrganization.DisplayNameForTheOrganization value))
            {
                return value;
            }
