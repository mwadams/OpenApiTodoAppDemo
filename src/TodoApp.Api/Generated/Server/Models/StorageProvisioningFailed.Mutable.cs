...
public readonly partial struct StorageProvisioningFailed
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Api.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.StorageProvisioningFailed.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Server.Models.StorageProvisioningFailed.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in TodoApp.Api.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.Server.Models.StorageProvisioningFailed.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Server.Models.StorageProvisioningFailed.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Server.Models.StorageProvisioningFailed.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Source entityType,
            in TodoApp.Api.Server.Models.JsonString.Source message = default)
        {
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Api.Server.Models.StorageProvisioningFailed.StatusEntity.ConstInstance);
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Server.Models.JsonUuid.Source entityId, in TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed.Source entityType, in TodoApp.Api.Server.Models.JsonString.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
