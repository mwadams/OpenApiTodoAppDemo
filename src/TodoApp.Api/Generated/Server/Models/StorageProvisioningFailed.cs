...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed EntityType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Api.Server.Models.StorageProvisioningFailed.TheKindOfEntityWhoseProvisioningFailed value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Api.Server.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.StorageProvisioningFailed.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Server.Models.StorageProvisioningFailed.StatusEntity value))
            {
                return value;
            }
