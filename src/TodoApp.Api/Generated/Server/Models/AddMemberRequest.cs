...
#endif
{
    ...
    /// </summary>
    public TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity Role
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity value))
            {
                return value;
            }

            return TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.DefaultInstance;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.JsonUuid UserId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Api.Server.Models.JsonUuid value))
            {
                return value;
            }
