...
#endif
{
    ...
    public TodoApp.Api.Server.Models.TodoItem this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<TodoApp.Api.Server.Models.TodoItem>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<TodoApp.Api.Server.Models.TodoItem> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Server.Models.TodoItem>(_parent, _idx);
    }
