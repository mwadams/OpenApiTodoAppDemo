    ...
    public static partial class JsonSchema
    {
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext oneOfContext0 =
                TodoApp.Api.Server.Models.UserStorageProvisioned.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
            TodoApp.Api.Server.Models.UserStorageProvisioned.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
            ...
            JsonSchemaContext oneOfContext1 =
                TodoApp.Api.Server.Models.OrganizationStorageProvisioned.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
            TodoApp.Api.Server.Models.OrganizationStorageProvisioned.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
            ...
            JsonSchemaContext oneOfContext2 =
                TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
            TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
            ...
            JsonSchemaContext oneOfContext3 =
                TodoApp.Api.Server.Models.StorageProvisioningFailed.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
            TodoApp.Api.Server.Models.StorageProvisioningFailed.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
