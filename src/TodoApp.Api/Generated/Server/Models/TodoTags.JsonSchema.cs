            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = TodoApp.Api.Server.Models.JsonString.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    TodoApp.Api.Server.Models.JsonString.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
