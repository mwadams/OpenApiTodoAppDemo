...
public readonly partial struct OrganizationMemberStorageProvisioned
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.JsonUuid.Mutable EntityId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityIdUtf8, out TodoApp.Api.Server.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.JsonUuid.Mutable OrgId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out TodoApp.Api.Server.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.AddMemberRequest.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Api.Server.Models.AddMemberRequest.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.JsonString.Mutable SasToken
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SasTokenUtf8, out TodoApp.Api.Server.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetEntityId(in TodoApp.Api.Server.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrgId(in TodoApp.Api.Server.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload(in TodoApp.Api.Server.Models.AddMemberRequest.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in TodoApp.Api.Server.Models.AddMemberRequest.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSasToken(in TodoApp.Api.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Server.Models.JsonUuid.Source entityId,
            in TodoApp.Api.Server.Models.JsonUuid.Source orgId,
            in TodoApp.Api.Server.Models.AddMemberRequest.Source payload,
            in TodoApp.Api.Server.Models.JsonString.Source sasToken)
        {
            entityId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntityId, ref builder);
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.EntityTypeEntity.ConstInstance);
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Api.Server.Models.OrganizationMemberStorageProvisioned.StatusEntity.ConstInstance);
        }
        ...
        internal static void Create<TContext>(
            ...
            in TodoApp.Api.Server.Models.JsonUuid.Source entityId,
            in TodoApp.Api.Server.Models.JsonUuid.Source orgId,
            in TodoApp.Api.Server.Models.AddMemberRequest.Source<TContext> payload,
            in TodoApp.Api.Server.Models.JsonString.Source sasToken)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Server.Models.JsonUuid.Source entityId, in TodoApp.Api.Server.Models.JsonUuid.Source orgId, in TodoApp.Api.Server.Models.AddMemberRequest.Source payload, in TodoApp.Api.Server.Models.JsonString.Source sasToken, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Api.Server.Models.JsonUuid.Source entityId, in TodoApp.Api.Server.Models.JsonUuid.Source orgId, in TodoApp.Api.Server.Models.AddMemberRequest.Source<TContext> payload, in TodoApp.Api.Server.Models.JsonString.Source sasToken, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
