...
public readonly partial struct NewTodo
{
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Server.Models.NewTodo.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Server.Models.NewTodo.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Server.Models.TodoTitle.Source title, in TodoApp.Api.Server.Models.JsonString.Source assignee = default, in TodoApp.Api.Server.Models.TodoDescription.Source description = default, in TodoApp.Api.Server.Models.JsonDateTime.Source dueDate = default, in TodoApp.Api.Server.Models.TodoPriority.Source priority = default, in TodoApp.Api.Server.Models.TodoStatus.Source status = default, in TodoApp.Api.Server.Models.TodoTags.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Api.Server.Models.TodoTitle.Source title, in TodoApp.Api.Server.Models.JsonString.Source assignee = default, in TodoApp.Api.Server.Models.TodoDescription.Source description = default, in TodoApp.Api.Server.Models.JsonDateTime.Source dueDate = default, in TodoApp.Api.Server.Models.TodoPriority.Source priority = default, in TodoApp.Api.Server.Models.TodoStatus.Source status = default, in TodoApp.Api.Server.Models.TodoTags.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
