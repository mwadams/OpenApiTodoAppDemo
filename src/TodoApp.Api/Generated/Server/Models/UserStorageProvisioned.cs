...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.UserStorageProvisioned.EntityTypeEntity EntityType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Api.Server.Models.UserStorageProvisioned.EntityTypeEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.NewUser Payload
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Api.Server.Models.NewUser value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.UserStorageProvisioned.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Server.Models.UserStorageProvisioned.StatusEntity value))
            {
                return value;
            }
