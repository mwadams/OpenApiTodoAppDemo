    ...
    : IJsonElement<TodoUpdate>
{
    public static partial class JsonSchema
    {
        ...
        private static PropertySchemaMatchers<TodoApp.Api.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
        {
            return new PropertySchemaMatchers<TodoApp.Api.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1>([
        ...
        private static PropertySchemaMatchers<TodoApp.Api.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out TodoApp.Api.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
        {
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out TodoApp.Api.Server.Models.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                    {
