...
public readonly partial struct OrganizationStorageProvisioned
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.OrganizationStorageProvisioned.EntityTypeEntity.Mutable EntityType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntityTypeUtf8, out TodoApp.Api.Server.Models.OrganizationStorageProvisioned.EntityTypeEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.NewOrganization.Mutable Payload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadUtf8, out TodoApp.Api.Server.Models.NewOrganization.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.OrganizationStorageProvisioned.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Server.Models.OrganizationStorageProvisioned.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntityType(in TodoApp.Api.Server.Models.OrganizationStorageProvisioned.EntityTypeEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload(in TodoApp.Api.Server.Models.NewOrganization.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPayload<TContext>(in TodoApp.Api.Server.Models.NewOrganization.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.Server.Models.OrganizationStorageProvisioned.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Server.Models.OrganizationStorageProvisioned.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Server.Models.OrganizationStorageProvisioned.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Server.Models.NewOrganization.Source payload,
            in TodoApp.Api.Server.Models.JsonString.Source sasToken)
        {
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.EntityType, TodoApp.Api.Server.Models.OrganizationStorageProvisioned.EntityTypeEntity.ConstInstance);
            ...
            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Status, TodoApp.Api.Server.Models.OrganizationStorageProvisioned.StatusEntity.ConstInstance);
        }
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in TodoApp.Api.Server.Models.JsonUuid.Source entityId,
            in TodoApp.Api.Server.Models.NewOrganization.Source<TContext> payload,
            in TodoApp.Api.Server.Models.JsonString.Source sasToken)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Server.Models.JsonUuid.Source entityId, in TodoApp.Api.Server.Models.NewOrganization.Source payload, in TodoApp.Api.Server.Models.JsonString.Source sasToken, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Api.Server.Models.JsonUuid.Source entityId, in TodoApp.Api.Server.Models.NewOrganization.Source<TContext> payload, in TodoApp.Api.Server.Models.JsonString.Source sasToken, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
