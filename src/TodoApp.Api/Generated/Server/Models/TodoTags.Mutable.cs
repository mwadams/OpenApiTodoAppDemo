...
public readonly partial struct TodoTags
{
...
#endif
    {
        ...
        public TodoApp.Api.Server.Models.JsonString.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Api.Server.Models.JsonString.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Api.Server.Models.JsonString.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Server.Models.JsonString.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in TodoApp.Api.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in TodoApp.Api.Server.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in TodoApp.Api.Server.Models.JsonString.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in TodoApp.Api.Server.Models.JsonString item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Api.Server.Models.JsonString>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<TodoApp.Api.Server.Models.JsonString> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Api.Server.Models.JsonString>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in TodoApp.Api.Server.Models.JsonString oldItem, in TodoApp.Api.Server.Models.JsonString.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Server.Models.JsonString>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                TodoApp.Api.Server.Models.JsonString current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Server.Models.TodoTags.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Server.Models.TodoTags.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
