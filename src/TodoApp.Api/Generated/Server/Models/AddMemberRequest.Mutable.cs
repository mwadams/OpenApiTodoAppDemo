...
public readonly partial struct AddMemberRequest
{
...
#endif
    {
        ...
        /// </summary>
        public TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.Mutable Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Server.Models.JsonUuid.Mutable UserId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Api.Server.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        public void SetRole(in TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUserId(in TodoApp.Api.Server.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Server.Models.AddMemberRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Server.Models.AddMemberRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Server.Models.JsonUuid.Source userId,
            in TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.Source role = default)
        {
        ...
        /// Creates an instance of a <see cref="AddMemberRequest"/>.
        /// </summary>
        public void Create(in TodoApp.Api.Server.Models.JsonUuid.Source userId, in TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.Source role = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Server.Models.JsonUuid.Source userId, in TodoApp.Api.Server.Models.AddMemberRequest.RoleEntity.Source role = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
