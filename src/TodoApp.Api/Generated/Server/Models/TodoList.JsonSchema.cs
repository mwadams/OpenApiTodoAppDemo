            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = TodoApp.Api.Server.Models.TodoItem.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    TodoApp.Api.Server.Models.TodoItem.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
