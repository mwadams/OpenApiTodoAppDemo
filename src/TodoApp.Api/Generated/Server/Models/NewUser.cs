...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.NewUser.HumanReadableDisplayNameForTheUser DisplayName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Api.Server.Models.NewUser.HumanReadableDisplayNameForTheUser value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Server.Models.JsonEmail Email
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Api.Server.Models.JsonEmail value))
            {
                return value;
            }
