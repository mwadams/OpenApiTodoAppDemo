...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryOrganization
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DirectoryOrganization instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DirectoryOrganization"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectoryOrganization(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.JsonUuid.Mutable Id
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Api.DirectoryStorage.JsonUuid.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetId(in TodoApp.Api.DirectoryStorage.JsonUuid.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetName(in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectoryOrganization.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryOrganization Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryOrganization Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DirectoryOrganization>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DirectoryOrganization instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DirectoryOrganization"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in TodoApp.Api.DirectoryStorage.JsonUuid.Source id,
                in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity.Source name)
            {
            ...
            /// Creates an instance of a <see cref="DirectoryOrganization"/>.
            /// </summary>
            public void Create(in TodoApp.Api.DirectoryStorage.JsonUuid.Source id, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity.Source name)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.DirectoryStorage.JsonUuid.Source id, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity.Source name, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<DirectoryOrganization, Mutable>(this);
        }
    }
}
