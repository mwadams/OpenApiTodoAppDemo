...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryMembership
    {
...
#endif
        {
            ...
            /// </summary>
            public static RoleEntity DefaultInstance { get; } = ParsedJsonDocument<RoleEntity>.StringConstant([.."\"member\""u8]);
            ...
            /// <param name="matchMember">Match 1st item.</param>
            /// <param name="matchAdmin">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchMember,
                Func<TContext, TResult> matchAdmin,
...
#endif
            {
                ...
                {
                    return matchMember(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchAdmin(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchMember,
                Func<TResult> matchAdmin,
