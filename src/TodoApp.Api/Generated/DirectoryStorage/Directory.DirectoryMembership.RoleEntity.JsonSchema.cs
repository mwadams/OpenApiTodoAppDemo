    ...
    public readonly partial struct DirectoryMembership
    {
            ...
            : IJsonElement<RoleEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "member"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RoleEntity EnumJson1 = ParsedJsonDocument<RoleEntity>.StringConstant([.."\"member\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "admin"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RoleEntity EnumJson2 = ParsedJsonDocument<RoleEntity>.StringConstant([.."\"admin\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "member"
                /// as a <see cref="RoleEntity"/>.
                /// </summary>
                public static RoleEntity Member { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "member"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> MemberUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "admin"
                /// as a <see cref="RoleEntity"/>.
                /// </summary>
                public static RoleEntity Admin { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "admin"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> AdminUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DirectoryMembership/properties/role"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/$defs/DirectoryMembership/properties/role";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DirectoryMembership/properties/role"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("member"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("admin"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
