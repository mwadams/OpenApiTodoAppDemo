...
public readonly partial struct Directory
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryMembership"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DirectoryMembership(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DirectoryMembership DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.JsonUuid OrgId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out TodoApp.Api.DirectoryStorage.JsonUuid value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity value))
                {
                    return value;
                }

                return TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.JsonString UserId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Api.DirectoryStorage.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in DirectoryMembership left, in DirectoryMembership right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DirectoryMembership left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DirectoryMembership instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DirectoryMembership(JsonElement instance)
        {
            return DirectoryMembership.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembership From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembership ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembership>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembership ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembership>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembership ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembership>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DirectoryMembership ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembership>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DirectoryMembership? result)
        {
            return JsonElementHelpers.TryParseValue<DirectoryMembership>(ref reader, out result);
        }
...
#if NET
        static DirectoryMembership IJsonElement<DirectoryMembership>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DirectoryMembership: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DirectoryMembership Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DirectoryMembership Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DirectoryMembership>(_idx);
            }
