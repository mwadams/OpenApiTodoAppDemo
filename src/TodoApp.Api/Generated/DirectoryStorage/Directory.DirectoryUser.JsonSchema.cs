        ...
        : IJsonElement<DirectoryUser>
    {
        public static partial class JsonSchema
        {
            ...
            private const uint RequiredBitMask0 =
                RequiredBitForDisplayName | RequiredBitForId;
            ...
            private static void MatchDisplayName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchEmail(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    TodoApp.Api.DirectoryStorage.JsonEmail.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                TodoApp.Api.DirectoryStorage.JsonEmail.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/DirectoryUser"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/DirectoryUser";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/DirectoryUser"u8;
