...
public readonly partial struct Directory
{
    ...
    /// <remarks>
    /// <para>
    /// A user entry in the directory blob.
    /// </para>
    /// </remarks>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct DirectoryUser
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DirectoryUser instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DirectoryUser"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectoryUser(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.Mutable DisplayName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public TodoApp.Api.DirectoryStorage.JsonEmail.Mutable Email
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Api.DirectoryStorage.JsonEmail.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.JsonString.Mutable Id
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Api.DirectoryStorage.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DirectoryUser(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetDisplayName(in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEmail(in TodoApp.Api.DirectoryStorage.JsonEmail.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetId(in TodoApp.Api.DirectoryStorage.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectoryUser.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DirectoryUser"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DirectoryUser"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryUser Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DirectoryUser>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DirectoryUser"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryUser Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DirectoryUser>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DirectoryUser instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DirectoryUser"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.Source displayName,
                in TodoApp.Api.DirectoryStorage.JsonString.Source id,
                in TodoApp.Api.DirectoryStorage.JsonEmail.Source email = default)
            {
            ...
            public void Create(
                ...
                in TodoApp.Api.DirectoryStorage.JsonEmail.Source email = default)
            {
                Create(ref _builder, displayName, id, email);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.DisplayNameEntity.Source displayName, in TodoApp.Api.DirectoryStorage.JsonString.Source id, in TodoApp.Api.DirectoryStorage.JsonEmail.Source email = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(displayName, id, email);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<DirectoryUser, Mutable>(this);
        }
    }
}
