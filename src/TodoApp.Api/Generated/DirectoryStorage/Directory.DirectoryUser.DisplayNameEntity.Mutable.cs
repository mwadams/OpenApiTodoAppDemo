    ...
    public readonly partial struct DirectoryUser
    {
        ...
        public readonly partial struct DisplayNameEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DisplayNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisplayNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisplayNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisplayNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisplayNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisplayNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisplayNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisplayNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisplayNameEntity, Mutable>(this);
            }
        }
    }
}
