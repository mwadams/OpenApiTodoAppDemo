...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryUserArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DirectoryUserArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DirectoryUserArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectoryUserArray(Mutable instance)
            {
            ...
            public TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DirectoryUserArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectoryUserArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Api.DirectoryStorage.Directory.DirectoryUser>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Api.DirectoryStorage.Directory.DirectoryUser>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser oldItem, in TodoApp.Api.DirectoryStorage.Directory.DirectoryUser.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    TodoApp.Api.DirectoryStorage.Directory.DirectoryUser current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="DirectoryUserArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DirectoryUserArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryUserArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DirectoryUserArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DirectoryUserArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryUserArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DirectoryUserArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DirectoryUserArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<DirectoryUserArray, Mutable>(this);
        }
    }
}
