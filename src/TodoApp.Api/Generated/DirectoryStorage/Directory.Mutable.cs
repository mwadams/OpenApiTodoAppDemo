...
public readonly partial struct Directory
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Directory instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Directory"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Directory(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>memberships</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Mutable Memberships
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MembershipsUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>organizations</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Mutable Organizations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrganizationsUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Mutable Users
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsersUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Directory(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>memberships</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMemberships(in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("memberships");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MembershipsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Memberships, ref cvb);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMemberships<TContext>(in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Source<TContext> value)
        ...
        /// <summary>
        /// Set the <c>organizations</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrganizations(in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("organizations");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrganizationsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Organizations, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrganizations<TContext>(in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUsers(in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("users");
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUsers<TContext>(in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Directory.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Directory"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Directory"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Directory Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Directory>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Directory"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Directory Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Directory>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.DirectoryStorage.Directory.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(Directory instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Directory"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Source memberships,
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Source organizations,
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source users)
        {
            memberships.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Memberships, ref builder);
            organizations.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Organizations, ref builder);
        ...
        public void Create(
            ...
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source users)
        {
            Create(ref _builder, memberships, organizations, users);
        }
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Source<TContext> memberships,
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Source<TContext> organizations,
            in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source<TContext> users)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, memberships, organizations, users);
        }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="memberships">The value of the property.</param>
    /// <param name="organizations">The value of the property.</param>
    /// <param name="users">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Source memberships, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Source organizations, in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source users, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(memberships, organizations, users);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Source<TContext> memberships, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Source<TContext> organizations, in TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray.Source<TContext> users, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, memberships, organizations, users);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Directory, Mutable>(this);
    }
}
