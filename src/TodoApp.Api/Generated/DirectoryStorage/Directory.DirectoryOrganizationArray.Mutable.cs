...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryOrganizationArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DirectoryOrganizationArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DirectoryOrganizationArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectoryOrganizationArray(Mutable instance)
            {
            ...
            public TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DirectoryOrganizationArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectoryOrganizationArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization oldItem, in TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="DirectoryOrganizationArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DirectoryOrganizationArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryOrganizationArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DirectoryOrganizationArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DirectoryOrganizationArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryOrganizationArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DirectoryOrganizationArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DirectoryOrganizationArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<DirectoryOrganizationArray, Mutable>(this);
        }
    }
}
