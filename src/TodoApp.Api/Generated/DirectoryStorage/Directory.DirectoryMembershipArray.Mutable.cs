...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryMembershipArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DirectoryMembershipArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DirectoryMembershipArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectoryMembershipArray(Mutable instance)
            {
            ...
            public TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DirectoryMembershipArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectoryMembershipArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership oldItem, in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="DirectoryMembershipArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DirectoryMembershipArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryMembershipArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DirectoryMembershipArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DirectoryMembershipArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryMembershipArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DirectoryMembershipArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DirectoryMembershipArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<DirectoryMembershipArray, Mutable>(this);
        }
    }
}
