...
public readonly partial struct Directory
{
        ...
        : IJsonElement<DirectoryOrganizationArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/organizations"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/properties/organizations";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/organizations"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
