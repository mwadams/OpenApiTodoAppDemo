...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryUserArray
        ...
        : IJsonElement<DirectoryUserArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryUserArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DirectoryUserArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DirectoryUserArray DefaultInstance { get; }
        ...
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryUser this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryUser>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in DirectoryUserArray left, in DirectoryUserArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DirectoryUserArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DirectoryUserArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DirectoryUserArray(JsonElement instance)
        {
            return DirectoryUserArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryUserArray From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryUserArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryUserArray>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryUserArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryUserArray>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryUserArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryUserArray>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DirectoryUserArray ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryUserArray>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DirectoryUserArray? result)
        {
            return JsonElementHelpers.TryParseValue<DirectoryUserArray>(ref reader, out result);
        }
...
#if NET
        static DirectoryUserArray IJsonElement<DirectoryUserArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DirectoryUserArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DirectoryUserArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DirectoryUserArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DirectoryUserArray>(_idx);
            }
