...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Directory"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal Directory(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static Directory DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray Memberships
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MembershipsUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryMembershipArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray Organizations
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrganizationsUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganizationArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray Users
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsersUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryUserArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in Directory left, in Directory right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Directory left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Directory instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Directory(JsonElement instance)
    {
        return Directory.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Directory From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Directory ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Directory>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Directory ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Directory>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Directory ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Directory>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static Directory ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<Directory>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Directory? result)
    {
        return JsonElementHelpers.TryParseValue<Directory>(ref reader, out result);
    }
...
#if NET
    static Directory IJsonElement<Directory>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Directory: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Memberships"/>.
        /// </summary>
        public const string Memberships = "memberships";

        /// <summary>
        /// Gets the JSON property name for <see cref="Organizations"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Memberships"/>.
        /// </summary>
        public static ReadOnlySpan<byte> MembershipsUtf8 => "memberships"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="Organizations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> OrganizationsUtf8 => "organizations"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Memberships"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Memberships => "memberships"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Organizations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Organizations => "organizations"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Memberships"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Memberships => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x65, 0x6D, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x73, 0x22];

        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Organizations"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Organizations => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x72, 0x67, 0x61, 0x6E, 0x69, 0x7A, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
