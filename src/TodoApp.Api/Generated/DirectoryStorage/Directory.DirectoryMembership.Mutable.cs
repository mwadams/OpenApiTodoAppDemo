...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryMembership
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DirectoryMembership instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DirectoryMembership"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DirectoryMembership(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.JsonUuid.Mutable OrgId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out TodoApp.Api.DirectoryStorage.JsonUuid.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity.Mutable Role
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// <para>
            /// The user&#39;s identity subject (sub)
            /// </para>
            /// </remarks>
            public TodoApp.Api.DirectoryStorage.JsonString.Mutable UserId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Api.DirectoryStorage.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DirectoryMembership(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetOrgId(in TodoApp.Api.DirectoryStorage.JsonUuid.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRole(in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUserId(in TodoApp.Api.DirectoryStorage.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DirectoryMembership.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DirectoryMembership"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DirectoryMembership"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryMembership Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DirectoryMembership>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DirectoryMembership"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DirectoryMembership Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DirectoryMembership>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DirectoryMembership instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DirectoryMembership"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in TodoApp.Api.DirectoryStorage.JsonUuid.Source orgId,
                in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity.Source role,
                in TodoApp.Api.DirectoryStorage.JsonString.Source userId)
            {
            ...
            public void Create(
                ...
                in TodoApp.Api.DirectoryStorage.JsonString.Source userId)
            {
                Create(ref _builder, orgId, role, userId);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.DirectoryStorage.JsonUuid.Source orgId, in TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership.RoleEntity.Source role, in TodoApp.Api.DirectoryStorage.JsonString.Source userId, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(orgId, role, userId);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<DirectoryMembership, Mutable>(this);
        }
    }
}
