...
public readonly partial struct Directory
{
    ...
    /// <remarks>
    /// <para>
    /// An organization entry in the directory blob.
    /// </para>
    /// </remarks>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct DirectoryOrganization
#if NET8_0_OR_GREATER
        : IJsonElement<DirectoryOrganization>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryOrganization"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DirectoryOrganization(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DirectoryOrganization DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.JsonUuid Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Api.DirectoryStorage.JsonUuid value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Api.DirectoryStorage.Directory.DirectoryOrganization.NameEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in DirectoryOrganization left, in DirectoryOrganization right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DirectoryOrganization left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DirectoryOrganization instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DirectoryOrganization(JsonElement instance)
        {
            return DirectoryOrganization.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryOrganization From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryOrganization ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryOrganization>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryOrganization ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryOrganization>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryOrganization ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryOrganization>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DirectoryOrganization ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryOrganization>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DirectoryOrganization? result)
        {
            return JsonElementHelpers.TryParseValue<DirectoryOrganization>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DirectoryOrganization(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DirectoryOrganization IJsonElement<DirectoryOrganization>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DirectoryOrganization: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DirectoryOrganization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DirectoryOrganization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DirectoryOrganization Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DirectoryOrganization>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DirectoryOrganization"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DirectoryOrganization Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DirectoryOrganization>(_idx);
            }
