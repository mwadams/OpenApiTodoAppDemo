...
public readonly partial struct Directory
{
    ...
    public readonly partial struct DirectoryMembershipArray
        ...
        : IJsonElement<DirectoryMembershipArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryMembershipArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DirectoryMembershipArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DirectoryMembershipArray DefaultInstance { get; }
        ...
        public TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.DirectoryStorage.Directory.DirectoryMembership>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in DirectoryMembershipArray left, in DirectoryMembershipArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DirectoryMembershipArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DirectoryMembershipArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DirectoryMembershipArray(JsonElement instance)
        {
            return DirectoryMembershipArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembershipArray From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembershipArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembershipArray>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembershipArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembershipArray>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DirectoryMembershipArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembershipArray>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static DirectoryMembershipArray ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<DirectoryMembershipArray>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DirectoryMembershipArray? result)
        {
            return JsonElementHelpers.TryParseValue<DirectoryMembershipArray>(ref reader, out result);
        }
...
#if NET
        static DirectoryMembershipArray IJsonElement<DirectoryMembershipArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DirectoryMembershipArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DirectoryMembershipArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DirectoryMembershipArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DirectoryMembershipArray>(_idx);
            }
