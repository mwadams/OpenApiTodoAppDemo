...
public readonly partial struct ProvisionResponse
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ProvisionResponse instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ProvisionResponse"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProvisionResponse(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.BrokerClient.Models.ProvisionResponse.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.BrokerClient.Models.ProvisionResponse.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// Provisioning ticket ID for polling status via GET /api/provisioning/status/{ticket}
        /// </para>
        /// </remarks>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProvisionResponse(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.BrokerClient.Models.ProvisionResponse.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProvisionResponse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProvisionResponse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProvisionResponse"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ProvisionResponse Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProvisionResponse>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProvisionResponse"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ProvisionResponse Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ProvisionResponse>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.BrokerClient.Models.ProvisionResponse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ProvisionResponse instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.BrokerClient.Models.ProvisionResponse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ProvisionResponse"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Api.BrokerClient.Models.ProvisionResponse.StatusEntity.Source status,
        ...
        public void Create(
            ...
            in TodoApp.Api.BrokerClient.Models.JsonString.Source message = default)
        {
            Create(ref _builder, status, ticket, message);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.BrokerClient.Models.ProvisionResponse.StatusEntity.Source status, in TodoApp.Api.BrokerClient.Models.JsonUuid.Source ticket, in TodoApp.Api.BrokerClient.Models.JsonString.Source message = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(status, ticket, message);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ProvisionResponse, Mutable>(this);
    }
}
