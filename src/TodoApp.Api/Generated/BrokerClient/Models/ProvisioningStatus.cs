...
public readonly partial struct ProvisioningStatus
    ...
    : IJsonElement<ProvisioningStatus>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ProvisioningStatus"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ProvisioningStatus(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ProvisioningStatus DefaultInstance { get; }
    ...
    /// </summary>
    public TodoApp.Api.BrokerClient.Models.JsonDateTime CreatedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CreatedAtUtf8, out TodoApp.Api.BrokerClient.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.BrokerClient.Models.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Api.BrokerClient.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.BrokerClient.Models.JsonInt32 RetryAfterSeconds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetryAfterSecondsUtf8, out TodoApp.Api.BrokerClient.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.BrokerClient.Models.JsonUuid Ticket
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TicketUtf8, out TodoApp.Api.BrokerClient.Models.JsonUuid value))
            {
                return value;
            }
    ...
    /// </summary>
    public TodoApp.Api.BrokerClient.Models.JsonDateTime UpdatedAt
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdatedAtUtf8, out TodoApp.Api.BrokerClient.Models.JsonDateTime value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ProvisioningStatus left, in ProvisioningStatus right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ProvisioningStatus left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ProvisioningStatus instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ProvisioningStatus(JsonElement instance)
    {
        return ProvisioningStatus.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisioningStatus From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisioningStatus ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisioningStatus>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisioningStatus ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisioningStatus>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisioningStatus ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisioningStatus>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ProvisioningStatus ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisioningStatus>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ProvisioningStatus? result)
    {
        return JsonElementHelpers.TryParseValue<ProvisioningStatus>(ref reader, out result);
    }
...
#if NET
    static ProvisioningStatus IJsonElement<ProvisioningStatus>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ProvisioningStatus: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public ProvisioningStatus Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public ProvisioningStatus Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ProvisioningStatus>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="RetryAfterSeconds"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Ticket"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="RetryAfterSeconds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RetryAfterSecondsUtf8 => "retryAfterSeconds"u8;
        ...
        /// Gets the JSON property name for <see cref="Ticket"/>.
        /// </summary>
        public static ReadOnlySpan<byte> TicketUtf8 => "ticket"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="RetryAfterSeconds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RetryAfterSeconds => "retryAfterSeconds"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Ticket"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Ticket => "ticket"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="RetryAfterSeconds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> RetryAfterSeconds => [0x35, 0x01, 0x00, 0x00, 0x22, 0x72, 0x65, 0x74, 0x72, 0x79, 0x41, 0x66, 0x74, 0x65, 0x72, 0x53, 0x65, 0x63, 0x6F, 0x6E, 0x64, 0x73, 0x22];
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Ticket"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Ticket => [0x85, 0x00, 0x00, 0x00, 0x22, 0x74, 0x69, 0x63, 0x6B, 0x65, 0x74, 0x22];
