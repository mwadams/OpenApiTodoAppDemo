...
public readonly partial struct ProvisionResponse
{
...
#endif
    {
        ...
        /// <param name="matchAccepted">Match 1st item.</param>
        /// <param name="matchAlreadyProvisioned">Match 2nd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchAccepted,
            Func<TContext, TResult> matchAlreadyProvisioned,
...
#endif
        {
            ...
            {
                return matchAccepted(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchAlreadyProvisioned(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchAccepted,
            Func<TResult> matchAlreadyProvisioned,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum2))
            {
                return matchAlreadyProvisioned();
            }
