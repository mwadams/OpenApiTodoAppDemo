...
namespace TodoApp.Api.BrokerClient.Models;
/// <summary>
/// Generated from JSON Schema.
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct ProvisioningStatus
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ProvisioningStatus instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ProvisioningStatus"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProvisioningStatus(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the (optional) <c>createdAt</c> property.
        /// </summary>
        public TodoApp.Api.BrokerClient.Models.JsonDateTime.Mutable CreatedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CreatedAtUtf8, out TodoApp.Api.BrokerClient.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// <remarks>
        /// <para>
        /// Human-readable status message or failure reason
        /// </para>
        /// </remarks>
        public TodoApp.Api.BrokerClient.Models.JsonString.Mutable Message
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out TodoApp.Api.BrokerClient.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>retryAfterSeconds</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Suggested polling interval in seconds. Present when status is &#39;provisioning&#39;.
        /// </para>
        /// </remarks>
        public TodoApp.Api.BrokerClient.Models.JsonInt32.Mutable RetryAfterSeconds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetryAfterSecondsUtf8, out TodoApp.Api.BrokerClient.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.BrokerClient.Models.JsonUuid.Mutable Ticket
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TicketUtf8, out TodoApp.Api.BrokerClient.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public TodoApp.Api.BrokerClient.Models.JsonDateTime.Mutable UpdatedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdatedAtUtf8, out TodoApp.Api.BrokerClient.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProvisioningStatus(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCreatedAt(in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CreatedAtUtf8);
        ...
        /// <summary>
        /// Remove the <c>createdAt</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveCreatedAt()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CreatedAtUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMessage(in TodoApp.Api.BrokerClient.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>retryAfterSeconds</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRetryAfterSeconds(in TodoApp.Api.BrokerClient.Models.JsonInt32.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RetryAfterSecondsUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetryAfterSecondsUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RetryAfterSeconds, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// <summary>
        /// Remove the <c>retryAfterSeconds</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveRetryAfterSeconds()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RetryAfterSecondsUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Set the <c>ticket</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTicket(in TodoApp.Api.BrokerClient.Models.JsonUuid.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("ticket");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TicketUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Ticket, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUpdatedAt(in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProvisioningStatus.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProvisioningStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProvisioningStatus"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ProvisioningStatus Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProvisioningStatus>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProvisioningStatus"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ProvisioningStatus Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ProvisioningStatus>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.BrokerClient.Models.ProvisioningStatus.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ProvisioningStatus instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.BrokerClient.Models.ProvisioningStatus.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ProvisioningStatus"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.Source status,
            in TodoApp.Api.BrokerClient.Models.JsonUuid.Source ticket,
            in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source createdAt = default,
            in TodoApp.Api.BrokerClient.Models.JsonString.Source message = default,
            in TodoApp.Api.BrokerClient.Models.JsonInt32.Source retryAfterSeconds = default,
            in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source updatedAt = default)
        {
            status.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Status, ref builder);
            ticket.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Ticket, ref builder);
            ...
            retryAfterSeconds.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RetryAfterSeconds, ref builder);
        ...
        public void Create(
            ...
            in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source updatedAt = default)
        {
            Create(ref _builder, status, ticket, createdAt, message, retryAfterSeconds, updatedAt);
        }
    ...
    /// <param name="ticket">The value of the property.</param>
    /// <param name="createdAt">The value of the property.</param>
    /// <param name="message">The value of the property.</param>
    /// <param name="retryAfterSeconds">The value of the property.</param>
    /// <param name="updatedAt">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.Source status, in TodoApp.Api.BrokerClient.Models.JsonUuid.Source ticket, in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source createdAt = default, in TodoApp.Api.BrokerClient.Models.JsonString.Source message = default, in TodoApp.Api.BrokerClient.Models.JsonInt32.Source retryAfterSeconds = default, in TodoApp.Api.BrokerClient.Models.JsonDateTime.Source updatedAt = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(status, ticket, createdAt, message, retryAfterSeconds, updatedAt);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ProvisioningStatus, Mutable>(this);
    }
}
