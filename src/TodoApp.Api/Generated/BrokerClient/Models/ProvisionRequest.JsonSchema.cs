    ...
    : IJsonElement<ProvisionRequest>
{
    ...
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCallbackUrlPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("callbackUrl"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCallbackUrlNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("callbackUrl"u8, buffer, out written);

        private const int RequiredOffsetForCallbackUrl = 0;
        private const uint RequiredBitForCallbackUrl = 0b00000000000000000000000000000001;
        ...
        private const uint RequiredBitMask0 =
            RequiredBitForCallbackUrl | RequiredBitForPayload;
        private static readonly JsonSchemaPathProvider CallbackUrlSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/callbackUrl"u8, buffer, out written);
        ...
        private static void MatchCallbackUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext =
                TodoApp.Api.BrokerClient.Models.JsonUriReference.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.CallbackUrlUtf8,
                    evaluationPath: CallbackUrlSchemaEvaluationPath);

            TodoApp.Api.BrokerClient.Models.JsonUriReference.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            requiredBitBuffer[RequiredOffsetForCallbackUrl] |= RequiredBitForCallbackUrl;
        }
        ...
        private static PropertySchemaMatchers<TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.CallbackUrlUtf8, MatchCallbackUrl),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ProvisionRequest"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ProvisionRequest";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ProvisionRequest"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCallbackUrlPresent, "callbackUrl"u8, "required"u8);
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCallbackUrl] & RequiredBitForCallbackUrl) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCallbackUrlNotPresent, "callbackUrl"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCallbackUrlPresent, "callbackUrl"u8, "required"u8);
