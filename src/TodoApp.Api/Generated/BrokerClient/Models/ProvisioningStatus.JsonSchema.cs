    ...
    : IJsonElement<ProvisioningStatus>
{
    public static partial class JsonSchema
    {
        ...
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTicketPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("ticket"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTicketNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("ticket"u8, buffer, out written);

        private const int RequiredOffsetForTicket = 0;
        private const uint RequiredBitForTicket = 0b00000000000000000000000000000010;

        private const uint RequiredBitMask0 =
            RequiredBitForStatus | RequiredBitForTicket;
        ...
        private static readonly JsonSchemaPathProvider RetryAfterSecondsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/retryAfterSeconds"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider TicketSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/ticket"u8, buffer, out written);
        ...
        private static void MatchCreatedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                TodoApp.Api.BrokerClient.Models.JsonDateTime.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Api.BrokerClient.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
        ...
        private static void MatchMessage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext1 =
                TodoApp.Api.BrokerClient.Models.JsonString.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Api.BrokerClient.Models.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            context.CommitChildContext(childContext1.IsMatch, ref childContext1);
        }

        private static void MatchRetryAfterSeconds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext2 =
                TodoApp.Api.BrokerClient.Models.JsonInt32.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.RetryAfterSecondsUtf8,
                    evaluationPath: RetryAfterSecondsSchemaEvaluationPath);

            TodoApp.Api.BrokerClient.Models.JsonInt32.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext3 =
                TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            TodoApp.Api.BrokerClient.Models.ProvisioningStatus.StatusEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
        ...
        private static void MatchTicket(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext4 =
                TodoApp.Api.BrokerClient.Models.JsonUuid.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.TicketUtf8,
                    evaluationPath: TicketSchemaEvaluationPath);

            TodoApp.Api.BrokerClient.Models.JsonUuid.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
            ...
            requiredBitBuffer[RequiredOffsetForTicket] |= RequiredBitForTicket;
        }
        ...
        private static void MatchUpdatedAt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            TodoApp.Api.BrokerClient.Models.JsonDateTime.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
            context.CommitChildContext(childContext5.IsMatch, ref childContext5);
        }

        private static PropertySchemaMatchers<TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.CreatedAtUtf8, MatchCreatedAt),
                (static () => JsonPropertyNames.MessageUtf8, MatchMessage),
                (static () => JsonPropertyNames.RetryAfterSecondsUtf8, MatchRetryAfterSeconds),
                (static () => JsonPropertyNames.StatusUtf8, MatchStatus),
                (static () => JsonPropertyNames.TicketUtf8, MatchTicket),
                (static () => JsonPropertyNames.UpdatedAtUtf8, MatchUpdatedAt),
            ]);
        }

        private static PropertySchemaMatchers<TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

        private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
        [NotNullWhen(true)]
#endif
        out TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator? matcher)
        {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ProvisioningStatus"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/components/schemas/ProvisioningStatus";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ProvisioningStatus"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (objectValidation_enumerator.MoveNext())
                {
                    ...
                    if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out TodoApp.Api.BrokerClient.Models.PropertiesValidationHandler_NamedPropertyValidator? validator))
                    {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    ...
                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTicketPresent, "ticket"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForTicket] & RequiredBitForTicket) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyTicketNotPresent, "ticket"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTicketPresent, "ticket"u8, "required"u8);
