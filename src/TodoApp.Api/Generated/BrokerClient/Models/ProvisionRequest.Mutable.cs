...
public readonly partial struct ProvisionRequest
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ProvisionRequest instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ProvisionRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProvisionRequest(Mutable instance)
        {
        ...
        /// <summary>
        /// Gets the <c>callbackUrl</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// URL to POST the provisioning notification to when storage is ready
        /// </para>
        /// </remarks>
        public TodoApp.Api.BrokerClient.Models.JsonUriReference.Mutable CallbackUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CallbackUrlUtf8, out TodoApp.Api.BrokerClient.Models.JsonUriReference.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// <para>
        /// Opaque data to echo back in the callback. Contains the original creation request so the stateless API can populate the newly provisioned storage. In production this would be encrypted; in this demo it is plaintext JSON.
        /// </para>
        /// </remarks>
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ProvisionRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// <summary>
        /// Set the <c>callbackUrl</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetCallbackUrl(in TodoApp.Api.BrokerClient.Models.JsonUriReference.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("callbackUrl");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CallbackUrlUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CallbackUrl, ref cvb);
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProvisionRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ProvisionRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ProvisionRequest"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ProvisionRequest Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ProvisionRequest>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ProvisionRequest"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ProvisionRequest Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ProvisionRequest>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.BrokerClient.Models.ProvisionRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ProvisionRequest instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.BrokerClient.Models.ProvisionRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ProvisionRequest"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Api.BrokerClient.Models.JsonUriReference.Source callbackUrl,
            in Corvus.Text.Json.JsonElement.Source payload)
        {
            callbackUrl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CallbackUrl, ref builder);
        ...
        /// Creates an instance of a <see cref="ProvisionRequest"/>.
        /// </summary>
        public void Create(in TodoApp.Api.BrokerClient.Models.JsonUriReference.Source callbackUrl, in Corvus.Text.Json.JsonElement.Source payload)
        {
            Create(ref _builder, callbackUrl, payload);
        }
        ...
        #endif
        {
            Create(context, ref _builder, callbackUrl, payload);
        }
    ...
    /// </summary>
    /// <param name="workspace">The JSON workspace.</param>
    /// <param name="callbackUrl">The value of the property.</param>
    /// <param name="payload">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.BrokerClient.Models.JsonUriReference.Source callbackUrl, in Corvus.Text.Json.JsonElement.Source payload, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(callbackUrl, payload);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Api.BrokerClient.Models.JsonUriReference.Source callbackUrl, in Corvus.Text.Json.JsonElement.Source<TContext> payload, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, callbackUrl, payload);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ProvisionRequest, Mutable>(this);
    }
}
