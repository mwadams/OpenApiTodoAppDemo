...
public readonly partial struct ProvisionResponse
{
        ...
        : IJsonElement<StatusEntity>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Enum1 = "accepted"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly StatusEntity EnumJson1 = ParsedJsonDocument<StatusEntity>.StringConstant([.."\"accepted\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "already-provisioned"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly StatusEntity EnumJson2 = ParsedJsonDocument<StatusEntity>.StringConstant([.."\"already-provisioned\""u8]);
        }
        ...
        public static class EnumValues
        {
            ...
            /// </summary>
            public static StatusEntity Accepted { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "accepted"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> AcceptedUtf8 => Constants.Enum1;

            /// <summary>
            /// Gets the string "already-provisioned"
            /// as a <see cref="StatusEntity"/>.
            /// </summary>
            public static StatusEntity AlreadyProvisioned { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "already-provisioned"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> AlreadyProvisionedUtf8 => Constants.Enum2;
        }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/components/schemas/ProvisionResponse/properties/status"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/components/schemas/ProvisionResponse/properties/status";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/components/schemas/ProvisionResponse/properties/status"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("accepted"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }

                    if (unescapedUtf8JsonString.Span.SequenceEqual("already-provisioned"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
