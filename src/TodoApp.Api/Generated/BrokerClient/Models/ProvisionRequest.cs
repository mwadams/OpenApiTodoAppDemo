...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ProvisionRequest"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ProvisionRequest(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ProvisionRequest DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.BrokerClient.Models.JsonUriReference CallbackUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CallbackUrlUtf8, out TodoApp.Api.BrokerClient.Models.JsonUriReference value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ProvisionRequest left, in ProvisionRequest right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ProvisionRequest left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ProvisionRequest instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ProvisionRequest(JsonElement instance)
    {
        return ProvisionRequest.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisionRequest From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisionRequest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisionRequest>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisionRequest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisionRequest>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProvisionRequest ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisionRequest>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ProvisionRequest ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ProvisionRequest>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ProvisionRequest? result)
    {
        return JsonElementHelpers.TryParseValue<ProvisionRequest>(ref reader, out result);
    }
...
#if NET
    static ProvisionRequest IJsonElement<ProvisionRequest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ProvisionRequest: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public ProvisionRequest Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ProvisionRequest>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="CallbackUrl"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="CallbackUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CallbackUrlUtf8 => "callbackUrl"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="CallbackUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CallbackUrl => "callbackUrl"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="CallbackUrl"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CallbackUrl => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x61, 0x6C, 0x6C, 0x62, 0x61, 0x63, 0x6B, 0x55, 0x72, 0x6C, 0x22];
