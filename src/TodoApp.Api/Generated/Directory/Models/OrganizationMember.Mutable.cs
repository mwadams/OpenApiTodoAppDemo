...
namespace TodoApp.Api.Directory.Models;
/// <summary>
...
public readonly partial struct OrganizationMember
{
...
#endif
    {
        ...
        /// </summary>
        public TodoApp.Api.Directory.Models.JsonDateTime.Mutable JoinedAt
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JoinedAtUtf8, out TodoApp.Api.Directory.Models.JsonDateTime.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonUuid.Mutable OrgId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgIdUtf8, out TodoApp.Api.Directory.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonUuid.Mutable ProvisioningTicket
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvisioningTicketUtf8, out TodoApp.Api.Directory.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.OrganizationMember.RoleEntity.Mutable Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.Directory.Models.OrganizationMember.RoleEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonUuid.Mutable UserId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdUtf8, out TodoApp.Api.Directory.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        public void SetJoinedAt(in TodoApp.Api.Directory.Models.JsonDateTime.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrgId(in TodoApp.Api.Directory.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProvisioningTicket(in TodoApp.Api.Directory.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRole(in TodoApp.Api.Directory.Models.OrganizationMember.RoleEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUserId(in TodoApp.Api.Directory.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.OrganizationMember.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.OrganizationMember.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.JsonUuid.Source orgId,
            in TodoApp.Api.Directory.Models.OrganizationMember.RoleEntity.Source role,
            in TodoApp.Api.Directory.Models.JsonUuid.Source userId,
            in TodoApp.Api.Directory.Models.JsonDateTime.Source joinedAt = default,
            in TodoApp.Api.Directory.Models.JsonUuid.Source provisioningTicket = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.JsonUuid.Source orgId, in TodoApp.Api.Directory.Models.OrganizationMember.RoleEntity.Source role, in TodoApp.Api.Directory.Models.JsonUuid.Source userId, in TodoApp.Api.Directory.Models.JsonDateTime.Source joinedAt = default, in TodoApp.Api.Directory.Models.JsonUuid.Source provisioningTicket = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
