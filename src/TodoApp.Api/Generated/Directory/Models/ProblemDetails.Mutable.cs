...
public readonly partial struct ProblemDetails
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonString.Mutable Detail
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DetailUtf8, out TodoApp.Api.Directory.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonUri.Mutable Instance
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstanceUtf8, out TodoApp.Api.Directory.Models.JsonUri.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonInt32.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Directory.Models.JsonInt32.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonString.Mutable Title
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out TodoApp.Api.Directory.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonUri.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out TodoApp.Api.Directory.Models.JsonUri.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDetail(in TodoApp.Api.Directory.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetInstance(in TodoApp.Api.Directory.Models.JsonUri.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.Directory.Models.JsonInt32.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTitle(in TodoApp.Api.Directory.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(in TodoApp.Api.Directory.Models.JsonUri.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.ProblemDetails.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.ProblemDetails.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.JsonInt32.Source status,
            in TodoApp.Api.Directory.Models.JsonUri.Source type,
            in TodoApp.Api.Directory.Models.JsonString.Source detail = default,
            in TodoApp.Api.Directory.Models.JsonUri.Source instance = default,
            in TodoApp.Api.Directory.Models.JsonString.Source title = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.JsonInt32.Source status, in TodoApp.Api.Directory.Models.JsonUri.Source type, in TodoApp.Api.Directory.Models.JsonString.Source detail = default, in TodoApp.Api.Directory.Models.JsonUri.Source instance = default, in TodoApp.Api.Directory.Models.JsonString.Source title = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
