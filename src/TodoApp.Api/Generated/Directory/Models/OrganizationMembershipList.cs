...
#endif
{
    ...
    public TodoApp.Api.Directory.Models.OrganizationMembership this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<TodoApp.Api.Directory.Models.OrganizationMembership>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<TodoApp.Api.Directory.Models.OrganizationMembership> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Directory.Models.OrganizationMembership>(_parent, _idx);
    }
