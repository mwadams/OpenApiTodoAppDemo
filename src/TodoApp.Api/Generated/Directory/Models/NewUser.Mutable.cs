...
public readonly partial struct NewUser
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser.Mutable DisplayName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDisplayName(in TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.NewUser.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.NewUser.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser.Source displayName,
        ...
        /// Creates an instance of a <see cref="NewUser"/>.
        /// </summary>
        public void Create(in TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser.Source displayName, in TodoApp.Api.Directory.Models.JsonEmail.Source email = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser.Source displayName, in TodoApp.Api.Directory.Models.JsonEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
