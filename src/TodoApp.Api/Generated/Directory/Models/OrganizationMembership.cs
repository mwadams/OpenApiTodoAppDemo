...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.JsonString OrgName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrgNameUtf8, out TodoApp.Api.Directory.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.OrganizationMembership.RoleEntity Role
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.Directory.Models.OrganizationMembership.RoleEntity value))
            {
                return value;
            }
