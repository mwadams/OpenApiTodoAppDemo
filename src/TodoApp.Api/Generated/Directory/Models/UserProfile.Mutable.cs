...
/// <remarks>
/// <para>
/// Full user profile including organization memberships.
/// </para>
/// </remarks>
...
public readonly partial struct UserProfile
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonString.Mutable DisplayName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Api.Directory.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public TodoApp.Api.Directory.Models.JsonEmail.Mutable Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out TodoApp.Api.Directory.Models.JsonEmail.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonString.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Api.Directory.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.OrganizationMembershipList.Mutable Organizations
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrganizationsUtf8, out TodoApp.Api.Directory.Models.OrganizationMembershipList.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDisplayName(in TodoApp.Api.Directory.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEmail(in TodoApp.Api.Directory.Models.JsonEmail.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(in TodoApp.Api.Directory.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrganizations(in TodoApp.Api.Directory.Models.OrganizationMembershipList.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetOrganizations<TContext>(in TodoApp.Api.Directory.Models.OrganizationMembershipList.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.UserProfile.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.UserProfile.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.JsonString.Source displayName,
            in TodoApp.Api.Directory.Models.JsonString.Source id,
            in TodoApp.Api.Directory.Models.OrganizationMembershipList.Source organizations,
            in TodoApp.Api.Directory.Models.JsonEmail.Source email = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in TodoApp.Api.Directory.Models.JsonString.Source displayName,
            in TodoApp.Api.Directory.Models.JsonString.Source id,
            in TodoApp.Api.Directory.Models.OrganizationMembershipList.Source<TContext> organizations,
            in TodoApp.Api.Directory.Models.JsonEmail.Source email = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.JsonString.Source displayName, in TodoApp.Api.Directory.Models.JsonString.Source id, in TodoApp.Api.Directory.Models.OrganizationMembershipList.Source organizations, in TodoApp.Api.Directory.Models.JsonEmail.Source email = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in TodoApp.Api.Directory.Models.JsonString.Source displayName, in TodoApp.Api.Directory.Models.JsonString.Source id, in TodoApp.Api.Directory.Models.OrganizationMembershipList.Source<TContext> organizations, in TodoApp.Api.Directory.Models.JsonEmail.Source email = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
