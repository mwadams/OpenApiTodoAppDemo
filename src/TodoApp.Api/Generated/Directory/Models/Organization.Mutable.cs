...
/// <remarks>
/// <para>
/// Organization creation response including provisioning status.
/// </para>
/// </remarks>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct Organization
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Organization instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Organization"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Organization(Mutable instance)
        {
        ...
        /// </summary>
        public TodoApp.Api.Directory.Models.JsonString.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Api.Directory.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonUuid.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out TodoApp.Api.Directory.Models.JsonUuid.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.JsonString.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Api.Directory.Models.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// <remarks>
        /// <para>
        /// Ticket ID for polling provisioning status. Present only on creation responses.
        /// </para>
        /// </remarks>
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.Organization.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Directory.Models.Organization.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Organization(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetDescription(in TodoApp.Api.Directory.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetId(in TodoApp.Api.Directory.Models.JsonUuid.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(in TodoApp.Api.Directory.Models.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.Directory.Models.Organization.StatusEntity.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Organization.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Organization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Organization"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Organization Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Organization>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Organization"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Organization Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Organization>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.Organization.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(Organization instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.Organization.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Organization"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in TodoApp.Api.Directory.Models.JsonUuid.Source id,
            in TodoApp.Api.Directory.Models.JsonString.Source name,
            in TodoApp.Api.Directory.Models.Organization.StatusEntity.Source status,
            in TodoApp.Api.Directory.Models.JsonString.Source description = default,
        ...
        public void Create(
            ...
            in TodoApp.Api.Directory.Models.JsonUuid.Source provisioningTicket = default)
        {
            Create(ref _builder, id, name, status, description, provisioningTicket);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.JsonUuid.Source id, in TodoApp.Api.Directory.Models.JsonString.Source name, in TodoApp.Api.Directory.Models.Organization.StatusEntity.Source status, in TodoApp.Api.Directory.Models.JsonString.Source description = default, in TodoApp.Api.Directory.Models.JsonUuid.Source provisioningTicket = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(id, name, status, description, provisioningTicket);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Organization, Mutable>(this);
    }
}
