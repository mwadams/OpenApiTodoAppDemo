...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser DisplayName
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayNameUtf8, out TodoApp.Api.Directory.Models.NewUser.HumanReadableDisplayNameForTheUser value))
            {
                return value;
            }
