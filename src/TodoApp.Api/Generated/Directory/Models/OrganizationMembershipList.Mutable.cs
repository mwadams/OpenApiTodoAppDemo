...
public readonly partial struct OrganizationMembershipList
{
...
#endif
    {
        ...
        public TodoApp.Api.Directory.Models.OrganizationMembership.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<TodoApp.Api.Directory.Models.OrganizationMembership.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<TodoApp.Api.Directory.Models.OrganizationMembership.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Directory.Models.OrganizationMembership.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in TodoApp.Api.Directory.Models.OrganizationMembership.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in TodoApp.Api.Directory.Models.OrganizationMembership.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in TodoApp.Api.Directory.Models.OrganizationMembership.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in TodoApp.Api.Directory.Models.OrganizationMembership item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, TodoApp.Api.Directory.Models.OrganizationMembership>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<TodoApp.Api.Directory.Models.OrganizationMembership> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, TodoApp.Api.Directory.Models.OrganizationMembership>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in TodoApp.Api.Directory.Models.OrganizationMembership oldItem, in TodoApp.Api.Directory.Models.OrganizationMembership.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<TodoApp.Api.Directory.Models.OrganizationMembership>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                TodoApp.Api.Directory.Models.OrganizationMembership current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.OrganizationMembershipList.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.OrganizationMembershipList.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
