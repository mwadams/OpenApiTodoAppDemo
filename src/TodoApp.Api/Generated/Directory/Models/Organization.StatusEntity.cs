...
public readonly partial struct Organization
{
...
#endif
    {
        ...
        /// <param name="matchProvisioning">Match 1st item.</param>
        /// <param name="matchActive">Match 2nd item.</param>
        /// <param name="matchDisabled">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchProvisioning,
            Func<TContext, TResult> matchActive,
            Func<TContext, TResult> matchDisabled,
...
#endif
        {
            ...
            {
                return matchProvisioning(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchProvisioning,
            Func<TResult> matchActive,
            Func<TResult> matchDisabled,
            Func<TResult> defaultMatch)
        {
            if (this.ValueEquals(Constants.Enum1))
            {
                return matchProvisioning();
            }
