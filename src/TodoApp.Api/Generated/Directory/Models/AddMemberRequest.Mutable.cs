...
public readonly partial struct AddMemberRequest
{
...
#endif
    {
        ...
        /// </summary>
        public TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.Mutable Role
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetRole(in TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.AddMemberRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.AddMemberRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.Source role = default)
        {
        ...
        /// Creates an instance of a <see cref="AddMemberRequest"/>.
        /// </summary>
        public void Create(in TodoApp.Api.Directory.Models.JsonUuid.Source userId, in TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.Source role = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.JsonUuid.Source userId, in TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.Source role = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
