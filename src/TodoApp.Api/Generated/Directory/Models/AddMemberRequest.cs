...
#endif
{
    ...
    /// </summary>
    public TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity Role
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoleUtf8, out TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity value))
            {
                return value;
            }

            return TodoApp.Api.Directory.Models.AddMemberRequest.RoleEntity.DefaultInstance;
        }
    }
