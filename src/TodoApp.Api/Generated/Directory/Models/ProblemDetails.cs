...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.JsonString Detail
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DetailUtf8, out TodoApp.Api.Directory.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.JsonUri Instance
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InstanceUtf8, out TodoApp.Api.Directory.Models.JsonUri value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.JsonInt32 Status
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Directory.Models.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.JsonString Title
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out TodoApp.Api.Directory.Models.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public TodoApp.Api.Directory.Models.JsonUri Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out TodoApp.Api.Directory.Models.JsonUri value))
            {
                return value;
            }
