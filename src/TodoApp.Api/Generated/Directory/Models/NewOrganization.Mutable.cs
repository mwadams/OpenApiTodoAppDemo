...
public readonly partial struct NewOrganization
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Mutable Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out TodoApp.Api.Directory.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.NewOrganization.DisplayNameForTheOrganization.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out TodoApp.Api.Directory.Models.NewOrganization.DisplayNameForTheOrganization.Mutable value))
                {
                    return value;
                }
        ...
        public void SetDescription(in TodoApp.Api.Directory.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetName(in TodoApp.Api.Directory.Models.NewOrganization.DisplayNameForTheOrganization.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.NewOrganization.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.NewOrganization.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.NewOrganization.DisplayNameForTheOrganization.Source name,
            in TodoApp.Api.Directory.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source description = default)
        {
        ...
        /// Creates an instance of a <see cref="NewOrganization"/>.
        /// </summary>
        public void Create(in TodoApp.Api.Directory.Models.NewOrganization.DisplayNameForTheOrganization.Source name, in TodoApp.Api.Directory.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source description = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.NewOrganization.DisplayNameForTheOrganization.Source name, in TodoApp.Api.Directory.Models.NewOrganization.OptionalDescriptionOfTheOrganizationSPurpose.Source description = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
