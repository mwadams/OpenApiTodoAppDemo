...
/// <remarks>
/// <para>
/// User creation response including provisioning status.
/// </para>
/// </remarks>
...
public readonly partial struct User
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public TodoApp.Api.Directory.Models.User.StatusEntity.Mutable Status
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out TodoApp.Api.Directory.Models.User.StatusEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetStatus(in TodoApp.Api.Directory.Models.User.StatusEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(TodoApp.Api.Directory.Models.User.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, TodoApp.Api.Directory.Models.User.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in TodoApp.Api.Directory.Models.User.StatusEntity.Source status,
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in TodoApp.Api.Directory.Models.JsonString.Source displayName, in TodoApp.Api.Directory.Models.JsonUuid.Source id, in TodoApp.Api.Directory.Models.User.StatusEntity.Source status, in TodoApp.Api.Directory.Models.JsonEmail.Source email = default, in TodoApp.Api.Directory.Models.JsonUuid.Source provisioningTicket = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
